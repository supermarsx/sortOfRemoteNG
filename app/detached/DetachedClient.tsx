...
const reviveConnection = (connection: Connection): Connection => ({
  ...connection,
  createdAt: typeof connection.createdAt === 'string' ? connection.createdAt : new Date(connection.createdAt).toISOString(),
  updatedAt: typeof connection.updatedAt === 'string' ? connection.updatedAt : new Date(connection.updatedAt).toISOString(),
  lastConnected: typeof connection.lastConnected === 'string' ? connection.lastConnected : connection.lastConnected ? new Date(connection.lastConnected).toISOString() : undefined,
});
