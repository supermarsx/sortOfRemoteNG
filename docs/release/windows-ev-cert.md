---
title: Windows EV code-signing certificate
description: Maintainer runbook for obtaining and integrating Windows release signing credentials.
permalink: /release/windows-ev-cert/
