...
| VNC                                                                                                      |      ◐ native TCP/RFB; legacy security opt-in, no VeNCrypt/Tight auth       |         ●         |          ●           |
...
| Cloud control planes (AWS / Azure / GCP / Proxmox / VMware / Hyper-V / LXD)                              |   ◐ per-vendor crates; Proxmox / VMware / LXD wired, cloud panels are not   |         ○         |          ◐           |
