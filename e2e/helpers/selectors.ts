export const S = {
  ...
  // Proxmox (t67; testids per .orchestration/logs/t67-e4.md)
  proxmoxPanel: '[data-testid="proxmox-panel"]',
  proxmoxIntegrationPanel: '[data-testid="proxmox-integration-panel"]',
  proxmoxEmbedded: '[data-testid="proxmox-embedded"]',
  proxmoxEmbeddedHeader: '[data-testid="proxmox-embedded-header"]',
  proxmoxHydrationError: '[data-testid="proxmox-hydration-error"]',
  proxmoxConnectionForm: '[data-testid="proxmox-connection-form"]',
  proxmoxHost: '[data-testid="proxmox-host"]',
  proxmoxPort: '[data-testid="proxmox-port"]',
  proxmoxUsername: '[data-testid="proxmox-username"]',
  proxmoxPassword: '[data-testid="proxmox-password"]',
  proxmoxRealm: '[data-testid="proxmox-realm"]',
  proxmoxRealmCustom: '[data-testid="proxmox-realm-custom"]',
  proxmoxAuthModePassword: '[data-testid="proxmox-auth-mode-password"]',
  proxmoxAuthModeApiToken: '[data-testid="proxmox-auth-mode-apitoken"]',
  proxmoxTokenId: '[data-testid="proxmox-token-id"]',
  proxmoxTokenSecret: '[data-testid="proxmox-token-secret"]',
  proxmoxTotpSecret: '[data-testid="proxmox-totp-secret"]',
  proxmoxTlsSkip: '[data-testid="proxmox-tls-skip"]',
  proxmoxFingerprint: '[data-testid="proxmox-fingerprint"]',
  proxmoxProbeCertBtn: '[data-testid="proxmox-probe-cert-btn"]',
  proxmoxProbeCertError: '[data-testid="proxmox-probe-cert-error"]',
  proxmoxCertProbe: '[data-testid="proxmox-cert-probe"]',
  proxmoxCertAcceptBtn: '[data-testid="proxmox-cert-accept-btn"]',
  proxmoxCertDismissBtn: '[data-testid="proxmox-cert-dismiss-btn"]',
  proxmoxTfaForm: '[data-testid="proxmox-tfa-form"]',
  proxmoxTfaCode: '[data-testid="proxmox-tfa-code"]',
  proxmoxTfaKind: '[data-testid="proxmox-tfa-kind"]',
  proxmoxTfaSubmit: '[data-testid="proxmox-tfa-submit"]',
  proxmoxTfaCancel: '[data-testid="proxmox-tfa-cancel"]',
  proxmoxBusyElsewhere: '[data-testid="proxmox-busy-elsewhere"]',
  proxmoxTakeoverBtn: '[data-testid="proxmox-takeover-btn"]',
  proxmoxOpenWebUi: '[data-testid="proxmox-open-web-ui"]',
  proxmoxOpenWebUiExternal: '[data-testid="proxmox-open-web-ui-external"]',
  proxmoxHeaderDisconnectBtn: '[data-testid="proxmox-header-disconnect-btn"]',
  ...
  proxmoxConsoleTab: '[data-testid="proxmox-tab-console"]',
  proxmoxDisconnectBtn: '[data-testid="proxmox-disconnect-btn"]',
  // Unimplemented at t67-e8 time — the dashboard, node rows and VM rows carry
  // no testids yet, so `28-proxmox` asserts on their rendered text instead.
  // Kept so a later executor can add the ids without touching the spec's imports.
