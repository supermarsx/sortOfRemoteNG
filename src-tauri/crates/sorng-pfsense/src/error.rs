...
impl PfsenseError {
    ...
    pub fn interface_not_found(name: &str) -> Self {
        Self::new(
            PfsenseErrorKind::InterfaceNotFound,
    ...
    pub fn alias_not_found(name: &str) -> Self {
        Self::new(
            PfsenseErrorKind::AliasNotFound,
    ...
    pub fn nat_rule_not_found(id: &str) -> Self {
        Self::new(
            PfsenseErrorKind::NatRuleNotFound,
            format!("NAT rule not found: {id}"),
        )
    }
    ...
    pub fn route_not_found(id: &str) -> Self {
        Self::new(
            PfsenseErrorKind::RouteNotFound,
    ...
    pub fn gateway_not_found(name: &str) -> Self {
        Self::new(
            PfsenseErrorKind::GatewayNotFound,
            format!("Gateway not found: {name}"),
        )
    }

    pub fn service_not_found(name: &str) -> Self {
        Self::new(
            PfsenseErrorKind::ServiceNotFound,
    ...
    pub fn cert_not_found(id: &str) -> Self {
        Self::new(
            PfsenseErrorKind::CertificateNotFound,
    ...
    pub fn group_not_found(name: &str) -> Self {
        Self::new(
            PfsenseErrorKind::GroupNotFound,
