...
impl VpnManager {
    ...
    pub async fn get_openvpn_server(
        client: &PfsenseClient,
        vpnid: u32,
    ) -> PfsenseResult<OpenVpnServer> {
        let resp: ApiResponse<OpenVpnServer> = client
            .api_get(&format!("vpn/openvpn/server/{vpnid}"))
            .await?;
        Ok(resp.data)
    }
    ...
    pub async fn create_openvpn_server(
        ...
        let resp: ApiResponse<OpenVpnServer> =
            client.api_post("vpn/openvpn/server", server).await?;
        Ok(resp.data)
    }
    ...
    pub async fn update_openvpn_server(
        ...
        let resp: ApiResponse<OpenVpnServer> = client
            .api_put(&format!("vpn/openvpn/server/{vpnid}"), server)
            .await?;
        Ok(resp.data)
    }
    ...
    pub async fn delete_openvpn_server(client: &PfsenseClient, vpnid: u32) -> PfsenseResult<()> {
        client
            .api_delete_void(&format!("vpn/openvpn/server/{vpnid}"))
            .await
    }
    ...
    pub async fn get_openvpn_client(
        client: &PfsenseClient,
        vpnid: u32,
    ) -> PfsenseResult<OpenVpnClient> {
        let resp: ApiResponse<OpenVpnClient> = client
            .api_get(&format!("vpn/openvpn/client/{vpnid}"))
            .await?;
        Ok(resp.data)
    }
    ...
    pub async fn create_openvpn_client(
        ...
        let resp: ApiResponse<OpenVpnClient> =
            client.api_post("vpn/openvpn/client", vpn_client).await?;
        Ok(resp.data)
    }

    pub async fn update_openvpn_client(
        client: &PfsenseClient,
        vpnid: u32,
        vpn_client: &OpenVpnClient,
    ) -> PfsenseResult<OpenVpnClient> {
        let resp: ApiResponse<OpenVpnClient> = client
            .api_put(&format!("vpn/openvpn/client/{vpnid}"), vpn_client)
            .await?;
        Ok(resp.data)
    }
    ...
    pub async fn delete_openvpn_client(client: &PfsenseClient, vpnid: u32) -> PfsenseResult<()> {
        client
            .api_delete_void(&format!("vpn/openvpn/client/{vpnid}"))
            .await
    }
    ...
    pub async fn update_ipsec_tunnel(
        ...
        let resp: ApiResponse<IpsecTunnel> = client
            .api_put(&format!("vpn/ipsec/{ikeid}"), tunnel)
            .await?;
        Ok(resp.data)
    }
    ...
    pub async fn apply_ipsec(client: &PfsenseClient) -> PfsenseResult<serde_json::Value> {
        client
            .api_post("vpn/ipsec/apply", &serde_json::json!({}))
            .await
    }

    // ── WireGuard tunnels ──

    pub async fn list_wireguard_tunnels(
        client: &PfsenseClient,
    ) -> PfsenseResult<Vec<WireGuardTunnel>> {
    ...
    pub async fn get_wireguard_tunnel(
        ...
        let resp: ApiResponse<WireGuardTunnel> = client
            .api_get(&format!("vpn/wireguard/tunnel/{id}"))
            .await?;
        Ok(resp.data)
    }
    ...
    pub async fn create_wireguard_tunnel(
        ...
        let resp: ApiResponse<WireGuardTunnel> =
            client.api_post("vpn/wireguard/tunnel", tunnel).await?;
        Ok(resp.data)
    }

    pub async fn update_wireguard_tunnel(
        client: &PfsenseClient,
        id: &str,
        tunnel: &WireGuardTunnel,
    ) -> PfsenseResult<WireGuardTunnel> {
        let resp: ApiResponse<WireGuardTunnel> = client
            .api_put(&format!("vpn/wireguard/tunnel/{id}"), tunnel)
            .await?;
        Ok(resp.data)
    }
    ...
    pub async fn delete_wireguard_tunnel(client: &PfsenseClient, id: &str) -> PfsenseResult<()> {
        client
            .api_delete_void(&format!("vpn/wireguard/tunnel/{id}"))
            .await
    }
    ...
    pub async fn list_wireguard_peers(
        ...
        let resp: ApiListResponse<WireGuardPeer> = client
            .api_get(&format!("vpn/wireguard/peer/{tunnel_id}"))
            .await?;
        Ok(resp.data)
    }
    ...
    pub async fn get_wireguard_peer(
        ...
        let resp: ApiResponse<WireGuardPeer> = client
            .api_get(&format!("vpn/wireguard/peer/detail/{id}"))
            .await?;
        Ok(resp.data)
    }
    ...
    pub async fn update_wireguard_peer(
        ...
        let resp: ApiResponse<WireGuardPeer> = client
            .api_put(&format!("vpn/wireguard/peer/{id}"), peer)
            .await?;
        Ok(resp.data)
    }
    ...
    pub async fn delete_wireguard_peer(client: &PfsenseClient, id: &str) -> PfsenseResult<()> {
        client
            .api_delete_void(&format!("vpn/wireguard/peer/{id}"))
            .await
    }

    pub async fn apply_wireguard(client: &PfsenseClient) -> PfsenseResult<serde_json::Value> {
        client
            .api_post("vpn/wireguard/apply", &serde_json::json!({}))
            .await
    }
}
