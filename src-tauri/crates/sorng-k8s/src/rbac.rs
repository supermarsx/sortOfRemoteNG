...
impl RbacManager {
    ...
    pub async fn get_role(client: &K8sClient, namespace: &str, name: &str) -> K8sResult<RoleInfo> {
        let url = format!("{}/{}", client.rbac_v1_namespaced_url(namespace, "roles"), name);
        client.get(&url).await
    }

    pub async fn create_role(client: &K8sClient, namespace: &str, config: &CreateRoleConfig) -> K8sResult<RoleInfo> {
    ...
    pub async fn delete_role(client: &K8sClient, namespace: &str, name: &str) -> K8sResult<serde_json::Value> {
        let url = format!("{}/{}", client.rbac_v1_namespaced_url(namespace, "roles"), name);
    ...
    pub async fn create_cluster_role(client: &K8sClient, config: &CreateClusterRoleConfig) -> K8sResult<ClusterRoleInfo> {
    ...
    pub async fn delete_cluster_role(client: &K8sClient, name: &str) -> K8sResult<serde_json::Value> {
        let url = format!("{}/{}", client.rbac_v1_url("clusterroles"), name);
        client.delete(&url).await
    }
    ...
    pub async fn get_role_binding(client: &K8sClient, namespace: &str, name: &str) -> K8sResult<RoleBindingInfo> {
        let url = format!("{}/{}", client.rbac_v1_namespaced_url(namespace, "rolebindings"), name);
        client.get(&url).await
    }

    pub async fn create_role_binding(client: &K8sClient, namespace: &str, config: &CreateRoleBindingConfig) -> K8sResult<RoleBindingInfo> {
    ...
    pub async fn delete_role_binding(client: &K8sClient, namespace: &str, name: &str) -> K8sResult<serde_json::Value> {
        let url = format!("{}/{}", client.rbac_v1_namespaced_url(namespace, "rolebindings"), name);
        client.delete(&url).await
    }
    ...
    pub async fn get_cluster_role_binding(client: &K8sClient, name: &str) -> K8sResult<ClusterRoleBindingInfo> {
        let url = format!("{}/{}", client.rbac_v1_url("clusterrolebindings"), name);
        client.get(&url).await
    }

    pub async fn create_cluster_role_binding(client: &K8sClient, config: &CreateClusterRoleBindingConfig) -> K8sResult<ClusterRoleBindingInfo> {
    ...
    pub async fn delete_cluster_role_binding(client: &K8sClient, name: &str) -> K8sResult<serde_json::Value> {
        let url = format!("{}/{}", client.rbac_v1_url("clusterrolebindings"), name);
        client.delete(&url).await
    }
    ...
    pub async fn get_service_account(client: &K8sClient, namespace: &str, name: &str) -> K8sResult<ServiceAccountInfo> {
        let url = format!("{}/{}", client.namespaced_url(namespace, "serviceaccounts"), name);
        client.get(&url).await
    }

    pub async fn create_service_account(client: &K8sClient, namespace: &str, config: &CreateServiceAccountConfig) -> K8sResult<ServiceAccountInfo> {
        let url = client.namespaced_url(namespace, "serviceaccounts");
        let image_pull_secrets: Vec<serde_json::Value> = config.image_pull_secrets.iter()
    ...
    pub async fn delete_service_account(client: &K8sClient, namespace: &str, name: &str) -> K8sResult<serde_json::Value> {
        let url = format!("{}/{}", client.namespaced_url(namespace, "serviceaccounts"), name);
        client.delete(&url).await
    }
    ...
    pub async fn create_token(
        ...
        let url = format!("{}/{}/token", client.namespaced_url(namespace, "serviceaccounts"), service_account);
