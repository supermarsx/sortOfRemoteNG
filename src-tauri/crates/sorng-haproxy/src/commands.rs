...
pub async fn haproxy_list_frontends(
    ...
    state.lock().await.list_frontends(&id).await.map_err(map_err)
}
...
pub async fn haproxy_get_frontend(
    ...
    state.lock().await.get_frontend(&id, &name).await.map_err(map_err)
}
...
pub async fn haproxy_get_backend(
    ...
    state.lock().await.get_backend(&id, &name).await.map_err(map_err)
}
...
pub async fn haproxy_list_servers(
    ...
    state.lock().await.list_servers(&id, &backend).await.map_err(map_err)
}
...
pub async fn haproxy_get_server(
    ...
    state.lock().await.get_server(&id, &backend, &server).await.map_err(map_err)
}
...
pub async fn haproxy_set_server_state(
    ...
    state.lock().await.set_server_state(&id, &backend, &server, action).await.map_err(map_err)
}
...
pub async fn haproxy_get_acl(
    ...
    state.lock().await.get_acl(&id, &acl_id).await.map_err(map_err)
}
...
pub async fn haproxy_add_acl_entry(
    ...
    state.lock().await.add_acl_entry(&id, &acl_id, &value).await.map_err(map_err)
}
...
pub async fn haproxy_del_acl_entry(
    ...
    state.lock().await.del_acl_entry(&id, &acl_id, &value).await.map_err(map_err)
}
...
pub async fn haproxy_clear_acl(
    ...
    state.lock().await.clear_acl(&id, &acl_id).await.map_err(map_err)
}
...
pub async fn haproxy_add_map_entry(
    ...
    state.lock().await.add_map_entry(&id, &map_id, &key, &value).await.map_err(map_err)
}
...
pub async fn haproxy_del_map_entry(
    ...
    state.lock().await.del_map_entry(&id, &map_id, &key).await.map_err(map_err)
}
...
pub async fn haproxy_set_map_entry(
    ...
    state.lock().await.set_map_entry(&id, &map_id, &key, &value).await.map_err(map_err)
}
...
pub async fn haproxy_clear_map(
    ...
    state.lock().await.clear_map(&id, &map_id).await.map_err(map_err)
}
...
pub async fn haproxy_list_stick_tables(
    ...
    state.lock().await.list_stick_tables(&id).await.map_err(map_err)
}
...
pub async fn haproxy_get_stick_table(
    ...
    state.lock().await.get_stick_table(&id, &name).await.map_err(map_err)
}
...
pub async fn haproxy_clear_stick_table(
    ...
    state.lock().await.clear_stick_table(&id, &name).await.map_err(map_err)
}
...
pub async fn haproxy_set_stick_table_entry(
    ...
    state.lock().await.set_stick_table_entry(&id, &name, &key, &data).await.map_err(map_err)
}
...
pub async fn haproxy_runtime_execute(
    ...
    state.lock().await.runtime_execute(&id, &command).await.map_err(map_err)
}
...
pub async fn haproxy_show_servers_state(
    ...
    state.lock().await.show_servers_state(&id).await.map_err(map_err)
}
...
pub async fn haproxy_show_backend_list(
    ...
    state.lock().await.show_backend_list(&id).await.map_err(map_err)
}
...
pub async fn haproxy_update_raw_config(
    ...
    state.lock().await.update_raw_config(&id, content).await.map_err(map_err)
}
...
pub async fn haproxy_validate_config(
    ...
    state.lock().await.validate_config(&id).await.map_err(map_err)
}

#[tauri::command]
pub async fn haproxy_reload(
    state: State<'_, HaproxyServiceState>,
    id: String,
) -> CmdResult<()> {
