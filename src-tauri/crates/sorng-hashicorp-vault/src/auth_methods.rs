...
impl AuthMethodManager {
    ...
    pub async fn userpass_create_user(
        ...
        client
            .userpass_create_user(mount, username, password, policies)
            .await
    }

    pub async fn userpass_read_user(
        client: &VaultClient,
        mount: &str,
        username: &str,
    ) -> VaultResult<Value> {
    ...
    pub async fn userpass_list_users(
        client: &VaultClient,
        mount: &str,
    ...
    pub async fn userpass_delete_user(
        client: &VaultClient,
        mount: &str,
        username: &str,
    ) -> VaultResult<()> {
    ...
    pub async fn approle_read_role(
        client: &VaultClient,
        mount: &str,
        name: &str,
    ) -> VaultResult<Value> {
