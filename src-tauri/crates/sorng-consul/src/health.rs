...
impl HealthManager {
    ...
    pub async fn node_health(client: &ConsulClient, node: &str) -> ConsulResult<Vec<ConsulHealthCheck>> {
    ...
    pub async fn service_health(client: &ConsulClient, service: &str) -> ConsulResult<Vec<ConsulServiceEntry>> {
    ...
    pub async fn list_checks_for_service(client: &ConsulClient, service: &str) -> ConsulResult<Vec<ConsulHealthCheck>> {
    ...
    pub async fn list_checks_in_state(client: &ConsulClient, state: &str) -> ConsulResult<Vec<ConsulHealthCheck>> {
    ...
    pub async fn check_health(client: &ConsulClient, check_id: &str) -> ConsulResult<ConsulHealthCheck> {
        ...
        Err(crate::error::ConsulError::not_found(format!("Check not found: {check_id}")))
    }
}
