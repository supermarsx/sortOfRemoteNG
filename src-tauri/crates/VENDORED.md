...
| -------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------- | ------------- |
| `sorng-rdp-vendor`         | `ironrdp` 0.14 (+ `ironrdp-blocking` 0.8, `ironrdp-svc` 0.6, `ironrdp-dvc` 0.5, `ironrdp-core` 0.1, `ironrdp-cliprdr[-native]` 0.5), `openh264` 0.8               | Keep the IronRDP generic tree behind one first-party, rlib-only dependency boundary. Release builds use the separately staged, hard-linked OpenH264 2.6 shared library; source-backed decoding remains available only for development. | 2026-08-29 | rdp-team      |
