...
pub fn is_command(command: &str) -> bool {
    matches!(
        ...
        "mrng_detect_format"
            ...
            | "od_build_auth_url"
            | "od_exchange_code"
            | "od_start_device_code"
            | "od_poll_device_code"
            | "od_client_credentials"
            | "od_add_session"
            | "od_remove_session"
            | "od_list_sessions"
            | "od_get_my_drive"
            ...
            | "od_shared_with_me"
            | "od_list_permissions"
            | "od_remove_permission"
            | "od_list_thumbnails"
            | "od_download_thumbnail"
            | "od_get_special_folder"
            | "od_init_delta"
            | "od_create_subscription"
            | "od_list_subscriptions"
            | "od_delete_subscription"
    )
}
...
pub fn build() -> impl Fn(tauri::ipc::Invoke<tauri::Wry>) -> bool + Send + Sync + 'static {
    tauri::generate_handler![
        ...
        mremoteng_dedicated_commands::mrng_decrypt_document,
        ...
        // OneDrive commands — Auth
        onedrive_commands::od_generate_pkce,
        onedrive_commands::od_build_auth_url,
        onedrive_commands::od_exchange_code,
        onedrive_commands::od_start_device_code,
        onedrive_commands::od_poll_device_code,
        onedrive_commands::od_client_credentials,
        // OneDrive commands — Session management
        onedrive_commands::od_add_session,
        onedrive_commands::od_remove_session,
        onedrive_commands::od_list_sessions,
        // OneDrive commands — Drives
        onedrive_commands::od_get_my_drive,
        onedrive_commands::od_list_drives,
        // OneDrive commands — Files & Folders
        onedrive_commands::od_get_item,
        onedrive_commands::od_get_item_by_path,
        onedrive_commands::od_list_children,
        onedrive_commands::od_list_root,
        onedrive_commands::od_download,
        onedrive_commands::od_upload_small,
        onedrive_commands::od_create_folder,
        onedrive_commands::od_rename,
        onedrive_commands::od_delete,
        onedrive_commands::od_restore,
        onedrive_commands::od_list_versions,
        // OneDrive commands — Search
        onedrive_commands::od_search,
        onedrive_commands::od_recent,
        // OneDrive commands — Sharing
        onedrive_commands::od_create_link,
        onedrive_commands::od_shared_with_me,
        // OneDrive commands — Permissions
        onedrive_commands::od_list_permissions,
        onedrive_commands::od_remove_permission,
        // OneDrive commands — Thumbnails
        onedrive_commands::od_list_thumbnails,
        onedrive_commands::od_download_thumbnail,
        // OneDrive commands — Special Folders
        onedrive_commands::od_get_special_folder,
        // OneDrive commands — Sync / Delta
        onedrive_commands::od_init_delta,
        // OneDrive commands — Webhooks
        onedrive_commands::od_create_subscription,
        onedrive_commands::od_list_subscriptions,
        onedrive_commands::od_delete_subscription,
    ]
}
