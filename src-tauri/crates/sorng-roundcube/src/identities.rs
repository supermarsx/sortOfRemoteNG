...
impl IdentityManager {
    ...
    pub async fn get(
        ...
        client
            .get(&format!("/users/{user_id}/identities/{id}"))
            .await
    }
    ...
    pub async fn create(
        ...
        debug!(
            "ROUNDCUBE create_identity user_id={user_id} name={}",
            req.name
        );
        client
            .post(&format!("/users/{user_id}/identities"), req)
            .await
    }
    ...
    pub async fn update(
        ...
        client
            .put(&format!("/users/{user_id}/identities/{id}"), req)
            .await
    }
    ...
    pub async fn delete(client: &RoundcubeClient, user_id: &str, id: &str) -> RoundcubeResult<()> {
        ...
        client
            .delete(&format!("/users/{user_id}/identities/{id}"))
            .await
    }
    ...
    pub async fn set_default(
        ...
        client
            .post_no_body(&format!("/users/{user_id}/identities/{id}/default"))
            .await
    }
}
