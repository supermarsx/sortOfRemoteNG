...
#[tauri::command]
pub async fn idrac_get_config(
    state: State<'_, IdracServiceState>,
) -> Result<Option<IdracConfigSafe>, String> {
    let svc = state.lock().await;
    Ok(svc.get_config())
}
...
#[tauri::command]
pub async fn idrac_get_system_info(
    state: State<'_, IdracServiceState>,
...
#[tauri::command]
pub async fn idrac_get_idrac_info(
    state: State<'_, IdracServiceState>,
) -> Result<IdracInfo, String> {
    let svc = state.lock().await;
    svc.get_idrac_info().await.map_err(|e| e.to_string())
}

#[tauri::command]
pub async fn idrac_set_asset_tag(
    state: State<'_, IdracServiceState>,
    tag: String,
) -> Result<(), String> {
    let svc = state.lock().await;
...
#[tauri::command]
pub async fn idrac_set_indicator_led(
    state: State<'_, IdracServiceState>,
    led_state: String,
) -> Result<(), String> {
    let svc = state.lock().await;
...
#[tauri::command]
pub async fn idrac_power_action(
    state: State<'_, IdracServiceState>,
    action: String,
) -> Result<(), String> {
...
#[tauri::command]
pub async fn idrac_get_power_metrics(
    state: State<'_, IdracServiceState>,
...
#[tauri::command]
pub async fn idrac_list_power_supplies(
    state: State<'_, IdracServiceState>,
) -> Result<Vec<PowerSupply>, String> {
    let svc = state.lock().await;
    svc.list_power_supplies().await.map_err(|e| e.to_string())
}

#[tauri::command]
pub async fn idrac_set_power_cap(
    state: State<'_, IdracServiceState>,
    watts: f64,
) -> Result<(), String> {
    let svc = state.lock().await;
...
#[tauri::command]
pub async fn idrac_get_thermal_data(
    state: State<'_, IdracServiceState>,
...
#[tauri::command]
pub async fn idrac_get_thermal_summary(
    state: State<'_, IdracServiceState>,
...
#[tauri::command]
pub async fn idrac_set_fan_offset(
    state: State<'_, IdracServiceState>,
    offset: i32,
) -> Result<(), String> {
    let svc = state.lock().await;
...
#[tauri::command]
pub async fn idrac_list_processors(
    state: State<'_, IdracServiceState>,
) -> Result<Vec<Processor>, String> {
    let svc = state.lock().await;
    svc.list_processors().await.map_err(|e| e.to_string())
}

#[tauri::command]
pub async fn idrac_list_memory(
    state: State<'_, IdracServiceState>,
) -> Result<Vec<MemoryDimm>, String> {
    let svc = state.lock().await;
    svc.list_memory().await.map_err(|e| e.to_string())
}

#[tauri::command]
pub async fn idrac_list_pcie_devices(
    state: State<'_, IdracServiceState>,
) -> Result<Vec<PcieDevice>, String> {
    let svc = state.lock().await;
...
#[tauri::command]
pub async fn idrac_list_storage_controllers(
    state: State<'_, IdracServiceState>,
) -> Result<Vec<StorageController>, String> {
    let svc = state.lock().await;
    svc.list_storage_controllers()
        .await
        .map_err(|e| e.to_string())
}

#[tauri::command]
pub async fn idrac_list_virtual_disks(
    state: State<'_, IdracServiceState>,
    controller_id: Option<String>,
) -> Result<Vec<VirtualDisk>, String> {
    let svc = state.lock().await;
    svc.list_virtual_disks(controller_id.as_deref())
        .await
        .map_err(|e| e.to_string())
}

#[tauri::command]
pub async fn idrac_list_physical_disks(
    state: State<'_, IdracServiceState>,
    controller_id: Option<String>,
) -> Result<Vec<PhysicalDisk>, String> {
    let svc = state.lock().await;
    svc.list_physical_disks(controller_id.as_deref())
        .await
        .map_err(|e| e.to_string())
}

#[tauri::command]
pub async fn idrac_list_enclosures(
    state: State<'_, IdracServiceState>,
) -> Result<Vec<StorageEnclosure>, String> {
    let svc = state.lock().await;
...
pub async fn idrac_create_virtual_disk(
    ...
    let svc = state.lock().await;
    svc.create_virtual_disk(params)
        .await
        .map_err(|e| e.to_string())
}

#[tauri::command]
pub async fn idrac_delete_virtual_disk(
    state: State<'_, IdracServiceState>,
    controller_id: String,
    volume_id: String,
) -> Result<(), String> {
    let svc = state.lock().await;
    svc.delete_virtual_disk(&controller_id, &volume_id)
        .await
        .map_err(|e| e.to_string())
}
...
pub async fn idrac_initialize_virtual_disk(
    ...
    let svc = state.lock().await;
    svc.initialize_virtual_disk(&controller_id, &volume_id, &init_type)
        .await
        .map_err(|e| e.to_string())
}
...
#[tauri::command]
pub async fn idrac_list_network_adapters(
    state: State<'_, IdracServiceState>,
...
#[tauri::command]
pub async fn idrac_list_network_ports(
    state: State<'_, IdracServiceState>,
) -> Result<Vec<NetworkPort>, String> {
    let svc = state.lock().await;
    svc.list_network_ports().await.map_err(|e| e.to_string())
}

#[tauri::command]
pub async fn idrac_get_network_config(
    state: State<'_, IdracServiceState>,
) -> Result<IdracNetworkConfig, String> {
    let svc = state.lock().await;
    svc.get_idrac_network_config()
        .await
        .map_err(|e| e.to_string())
}
...
#[tauri::command]
pub async fn idrac_list_firmware(
    state: State<'_, IdracServiceState>,
) -> Result<Vec<FirmwareInventory>, String> {
    let svc = state.lock().await;
...
#[tauri::command]
pub async fn idrac_get_component_version(
    state: State<'_, IdracServiceState>,
    component_name: String,
) -> Result<Option<String>, String> {
    let svc = state.lock().await;
    svc.get_component_version(&component_name)
        .await
        .map_err(|e| e.to_string())
}
...
pub async fn idrac_wait_for_job(
    ...
    svc.wait_for_job(
        ...
        poll_interval_secs.unwrap_or(10),
    )
    .await
    .map_err(|e| e.to_string())
}
...
#[tauri::command]
pub async fn idrac_list_virtual_media(
    state: State<'_, IdracServiceState>,
...
pub async fn idrac_mount_virtual_media(
    ...
    let svc = state.lock().await;
    svc.mount_virtual_media(params)
        .await
        .map_err(|e| e.to_string())
}

#[tauri::command]
pub async fn idrac_unmount_virtual_media(
    state: State<'_, IdracServiceState>,
    media_id: String,
) -> Result<(), String> {
    let svc = state.lock().await;
    svc.unmount_virtual_media(&media_id)
        .await
        .map_err(|e| e.to_string())
}
...
#[tauri::command]
pub async fn idrac_get_console_info(
    state: State<'_, IdracServiceState>,
...
#[tauri::command]
pub async fn idrac_set_console_enabled(
    state: State<'_, IdracServiceState>,
    enabled: bool,
) -> Result<(), String> {
    let svc = state.lock().await;
    svc.set_console_enabled(enabled)
        .await
        .map_err(|e| e.to_string())
}

#[tauri::command]
pub async fn idrac_set_console_type(
    state: State<'_, IdracServiceState>,
    plugin_type: String,
) -> Result<(), String> {
    let svc = state.lock().await;
    svc.set_console_type(&plugin_type)
        .await
        .map_err(|e| e.to_string())
}

#[tauri::command]
pub async fn idrac_set_vnc_enabled(
    state: State<'_, IdracServiceState>,
    enabled: bool,
) -> Result<(), String> {
    let svc = state.lock().await;
    svc.set_vnc_enabled(enabled)
        .await
        .map_err(|e| e.to_string())
}

#[tauri::command]
pub async fn idrac_set_vnc_password(
    state: State<'_, IdracServiceState>,
    password: String,
) -> Result<(), String> {
    let svc = state.lock().await;
    svc.set_vnc_password(&password)
        .await
        .map_err(|e| e.to_string())
}
...
#[tauri::command]
pub async fn idrac_get_sel_entries(
    state: State<'_, IdracServiceState>,
    max_entries: Option<u32>,
) -> Result<Vec<SelEntry>, String> {
    let svc = state.lock().await;
    svc.get_sel_entries(max_entries)
        .await
        .map_err(|e| e.to_string())
}

#[tauri::command]
pub async fn idrac_get_lc_log_entries(
    state: State<'_, IdracServiceState>,
    max_entries: Option<u32>,
) -> Result<Vec<LcLogEntry>, String> {
    let svc = state.lock().await;
    svc.get_lc_log_entries(max_entries)
        .await
        .map_err(|e| e.to_string())
}
...
#[tauri::command]
pub async fn idrac_list_users(
    state: State<'_, IdracServiceState>,
) -> Result<Vec<IdracUser>, String> {
    let svc = state.lock().await;
...
pub async fn idrac_create_or_update_user(
    ...
    let svc = state.lock().await;
    svc.create_or_update_user(params)
        .await
        .map_err(|e| e.to_string())
}

#[tauri::command]
pub async fn idrac_delete_user(
    state: State<'_, IdracServiceState>,
    slot_id: String,
) -> Result<(), String> {
    let svc = state.lock().await;
...
#[tauri::command]
pub async fn idrac_unlock_user(
    state: State<'_, IdracServiceState>,
    slot_id: String,
) -> Result<(), String> {
    let svc = state.lock().await;
...
#[tauri::command]
pub async fn idrac_change_user_password(
    state: State<'_, IdracServiceState>,
    slot_id: String,
    new_password: String,
) -> Result<(), String> {
    let svc = state.lock().await;
    svc.change_user_password(&slot_id, &new_password)
        .await
        .map_err(|e| e.to_string())
}

#[tauri::command]
pub async fn idrac_get_ldap_config(
    state: State<'_, IdracServiceState>,
...
#[tauri::command]
pub async fn idrac_get_ad_config(
    state: State<'_, IdracServiceState>,
) -> Result<ActiveDirectoryConfig, String> {
    let svc = state.lock().await;
...
#[tauri::command]
pub async fn idrac_get_bios_attributes(
    state: State<'_, IdracServiceState>,
...
#[tauri::command]
pub async fn idrac_get_bios_attribute(
    state: State<'_, IdracServiceState>,
    name: String,
) -> Result<Option<String>, String> {
    let svc = state.lock().await;
    svc.get_bios_attribute(&name)
        .await
        .map_err(|e| e.to_string())
}
...
#[tauri::command]
pub async fn idrac_get_boot_order(
    state: State<'_, IdracServiceState>,
...
#[tauri::command]
pub async fn idrac_set_boot_order(
    state: State<'_, IdracServiceState>,
    boot_order: Vec<String>,
) -> Result<(), String> {
    let svc = state.lock().await;
    svc.set_boot_order(&boot_order)
        .await
        .map_err(|e| e.to_string())
}

#[tauri::command]
pub async fn idrac_set_boot_once(
    state: State<'_, IdracServiceState>,
    target: String,
    mode: Option<String>,
) -> Result<(), String> {
    let svc = state.lock().await;
    svc.set_boot_once(&target, mode.as_deref())
        .await
        .map_err(|e| e.to_string())
}

#[tauri::command]
pub async fn idrac_set_boot_mode(
    state: State<'_, IdracServiceState>,
    mode: String,
) -> Result<String, String> {
    let svc = state.lock().await;
...
#[tauri::command]
pub async fn idrac_list_certificates(
    state: State<'_, IdracServiceState>,
) -> Result<Vec<IdracCertificate>, String> {
    let svc = state.lock().await;
...
#[tauri::command]
pub async fn idrac_import_certificate(
    state: State<'_, IdracServiceState>,
    cert_pem: String,
    cert_type: String,
) -> Result<(), String> {
    let svc = state.lock().await;
    svc.import_certificate(&cert_pem, &cert_type)
        .await
        .map_err(|e| e.to_string())
}

#[tauri::command]
pub async fn idrac_delete_certificate(
    state: State<'_, IdracServiceState>,
    cert_id: String,
) -> Result<(), String> {
    let svc = state.lock().await;
    svc.delete_certificate(&cert_id)
        .await
        .map_err(|e| e.to_string())
}

#[tauri::command]
pub async fn idrac_replace_ssl_certificate(
    state: State<'_, IdracServiceState>,
    cert_pem: String,
    key_pem: String,
) -> Result<(), String> {
    let svc = state.lock().await;
    svc.replace_ssl_certificate(&cert_pem, &key_pem)
        .await
        .map_err(|e| e.to_string())
}
...
#[tauri::command]
pub async fn idrac_get_health_rollup(
    state: State<'_, IdracServiceState>,
) -> Result<ServerHealthRollup, String> {
    let svc = state.lock().await;
    svc.get_health_rollup().await.map_err(|e| e.to_string())
}

#[tauri::command]
pub async fn idrac_get_component_health(
    state: State<'_, IdracServiceState>,
) -> Result<Vec<(String, ComponentHealth)>, String> {
    let svc = state.lock().await;
...
#[tauri::command]
pub async fn idrac_get_power_telemetry(
    state: State<'_, IdracServiceState>,
) -> Result<PowerTelemetry, String> {
    let svc = state.lock().await;
    svc.get_power_telemetry().await.map_err(|e| e.to_string())
}

#[tauri::command]
pub async fn idrac_get_thermal_telemetry(
    state: State<'_, IdracServiceState>,
) -> Result<ThermalTelemetry, String> {
    let svc = state.lock().await;
    svc.get_thermal_telemetry().await.map_err(|e| e.to_string())
}

#[tauri::command]
pub async fn idrac_list_telemetry_reports(
    state: State<'_, IdracServiceState>,
) -> Result<Vec<TelemetryReport>, String> {
    let svc = state.lock().await;
    svc.list_telemetry_reports()
        .await
        .map_err(|e| e.to_string())
}

#[tauri::command]
pub async fn idrac_get_telemetry_report(
    state: State<'_, IdracServiceState>,
    report_id: String,
) -> Result<Vec<TelemetryDataPoint>, String> {
    let svc = state.lock().await;
    svc.get_telemetry_report(&report_id)
        .await
        .map_err(|e| e.to_string())
}
...
#[tauri::command]
pub async fn idrac_racadm_execute(
    state: State<'_, IdracServiceState>,
    command: String,
) -> Result<RacadmResult, String> {
    let svc = state.lock().await;
    svc.racadm_execute(&command)
        .await
        .map_err(|e| e.to_string())
}
...
#[tauri::command]
pub async fn idrac_get_attribute(
    state: State<'_, IdracServiceState>,
    name: String,
) -> Result<Option<String>, String> {
    let svc = state.lock().await;
    svc.get_idrac_attribute(&name)
        .await
        .map_err(|e| e.to_string())
}

#[tauri::command]
pub async fn idrac_set_attribute(
    state: State<'_, IdracServiceState>,
    name: String,
    value: String,
) -> Result<(), String> {
    let svc = state.lock().await;
    svc.set_idrac_attribute(&name, &value)
        .await
        .map_err(|e| e.to_string())
}
...
#[tauri::command]
pub async fn idrac_get_dashboard(
    state: State<'_, IdracServiceState>,
) -> Result<IdracDashboard, String> {
    let svc = state.lock().await;
