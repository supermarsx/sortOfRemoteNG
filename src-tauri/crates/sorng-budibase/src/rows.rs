...
impl RowManager {
    pub async fn list(client: &BudibaseClient, table_id: &str) -> BudibaseResult<Vec<BudibaseRow>> {
        ...
        let resp = client
            .post(&format!("/tables/{}/rows/search", table_id), &body)
            .await?;
    ...
    pub async fn get(
        ...
        let resp = client
            .get(&format!("/tables/{}/rows/{}", table_id, row_id))
            .await?;
        let row: BudibaseRow =
    ...
    pub async fn create(
        ...
        let resp = client
            .post(&format!("/tables/{}/rows", table_id), &body)
            .await?;
        let created: BudibaseRow =
            serde_json::from_value(resp.get("data").cloned().unwrap_or(resp.clone()))?;
        Ok(created)
    }
    ...
    pub async fn update(
        ...
        let body = serde_json::to_value(row)?;
        let resp = client
            .put(&format!("/tables/{}/rows/{}", table_id, row_id), &body)
            .await?;
        let updated: BudibaseRow =
            serde_json::from_value(resp.get("data").cloned().unwrap_or(resp.clone()))?;
        Ok(updated)
    }
    ...
    pub async fn delete(
        ...
        client
            .delete(&format!("/tables/{}/rows/{}", table_id, row_id))
            .await?;
        Ok(())
    }
    ...
    pub async fn bulk_delete(
        ...
        let body = serde_json::to_value(req)?;
        let resp = client
            .post(&format!("/tables/{}/rows/delete", table_id), &body)
            .await?;
        let result: BulkRowResponse = serde_json::from_value(resp)?;
        Ok(result)
    }
