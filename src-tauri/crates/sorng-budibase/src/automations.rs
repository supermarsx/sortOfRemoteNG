...
impl AutomationManager {
    ...
    pub async fn get(
        ...
        let resp = client
            .get(&format!("/automations/{}", automation_id))
            .await?;
        let automation: BudibaseAutomation =
    ...
    pub async fn update(
        ...
        let body = serde_json::to_value(req)?;
        let resp = client
            .put(&format!("/automations/{}", automation_id), &body)
            .await?;
        let automation: BudibaseAutomation =
            serde_json::from_value(resp.get("data").cloned().unwrap_or(resp.clone()))?;
        Ok(automation)
    ...
    pub async fn delete(client: &BudibaseClient, automation_id: &str) -> BudibaseResult<()> {
        client
            .delete(&format!("/automations/{}", automation_id))
            .await?;
        Ok(())
    }
    ...
    pub async fn trigger(
        ...
        let body = serde_json::to_value(req)?;
        let resp = client
            .post(&format!("/automations/{}/trigger", automation_id), &body)
            .await?;
