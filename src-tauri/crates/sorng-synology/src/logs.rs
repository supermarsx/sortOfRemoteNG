...
impl LogsManager {
    ...
    pub async fn get_system_logs(
        ...
        let v = client
            .best_version("SYNO.Core.SyslogClient.Log", 1)
            .unwrap_or(1);
    ...
    pub async fn get_connection_logs(
        ...
        let v = client
            .best_version("SYNO.Core.CurrentConnection", 2)
            .unwrap_or(1);
        let off = offset.to_string();
        let lim = limit.to_string();
        client
    ...
    pub async fn get_active_connections(
        ...
        let v = client
            ...
            .unwrap_or(1);
        client
            .api_call("SYNO.Core.CurrentConnection", v, "list", &[])
            .await
    }
    ...
    pub async fn clear_logs(client: &SynoClient) -> SynologyResult<()> {
        let v = client
            ...
            .unwrap_or(1);
        client
            .api_post_void("SYNO.Core.SyslogClient.Log", v, "clear", &[])
            .await
    }
}
