...
impl DownloadStationManager {
    ...
    pub async fn get_info(client: &SynoClient) -> SynologyResult<DownloadStationInfo> {
        let v = client.best_version("SYNO.DownloadStation.Info", 2).unwrap_or(1);
        client.api_call("SYNO.DownloadStation.Info", v, "getinfo", &[]).await
    }

    /// Get config / settings.
    pub async fn get_config(client: &SynoClient) -> SynologyResult<serde_json::Value> {
        let v = client.best_version("SYNO.DownloadStation.Info", 2).unwrap_or(1);
        client.api_call("SYNO.DownloadStation.Info", v, "getconfig", &[]).await
    }

    /// Get transfer statistics.
    pub async fn get_stats(client: &SynoClient) -> SynologyResult<DownloadStationStats> {
        let v = client.best_version("SYNO.DownloadStation.Statistic", 1).unwrap_or(1);
        client.api_call("SYNO.DownloadStation.Statistic", v, "getinfo", &[]).await
    }

    /// List all download tasks.
    pub async fn list_tasks(client: &SynoClient) -> SynologyResult<Vec<DownloadTask>> {
        let v = client.best_version("SYNO.DownloadStation.Task", 3).unwrap_or(1);
        client.api_call(
    ...
    pub async fn create_task(
        ...
        client.api_post_void("SYNO.DownloadStation.Task", v, "create", &params).await
    }

    /// Pause a download task.
    pub async fn pause_task(client: &SynoClient, task_id: &str) -> SynologyResult<()> {
        let v = client.best_version("SYNO.DownloadStation.Task", 3).unwrap_or(1);
        client.api_post_void("SYNO.DownloadStation.Task", v, "pause", &[("id", task_id)]).await
    }

    /// Resume a download task.
    pub async fn resume_task(client: &SynoClient, task_id: &str) -> SynologyResult<()> {
        let v = client.best_version("SYNO.DownloadStation.Task", 3).unwrap_or(1);
        client.api_post_void("SYNO.DownloadStation.Task", v, "resume", &[("id", task_id)]).await
    }
    ...
    pub async fn list_rss_feeds(client: &SynoClient) -> SynologyResult<serde_json::Value> {
        let v = client.best_version("SYNO.DownloadStation.RSS.Site", 1).unwrap_or(1);
        client.api_call("SYNO.DownloadStation.RSS.Site", v, "list", &[]).await
    }
