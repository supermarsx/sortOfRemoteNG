...
impl Default for ManPageLookup {
    fn default() -> Self {
        Self::new()
    }
}
...
impl ManPageLookup {
    ...
    pub async fn lookup(
        ...
        Err(AiAssistError::not_found(&format!(
            "man page for '{}'",
            command
        )))
    }
...
{{
  ...
  "see_also": ["related-command1", "related-command2"]
    ...
    fn parse_man_response(command: &str, content: &str) -> Result<ManPageInfo, AiAssistError> {
        ...
        let examples: Vec<CommandExample> = val
            .get("examples")
            .and_then(|v| v.as_array())
            .map(|arr| {
                arr.iter()
    ...
    fn populate_builtins(cache: &mut HashMap<String, ManPageInfo>) {
        ...
        cache.insert(
            ...
            ManPageInfo {
                ...
                common_flags: vec![
                    ...
                    FlagInfo {
                        flag: "-h".to_string(),
                        long_flag: Some("--human-readable".to_string()),
                        description: "Print sizes in human readable format".to_string(),
                        takes_value: false,
                        required: false,
                        common: true,
                    },
                    FlagInfo {
                        ...
                        description: "List subdirectories recursively".to_string(),
                        takes_value: false,
                        required: false,
                        common: true,
                    },
                    FlagInfo {
                        flag: "-t".to_string(),
                        long_flag: None,
                        description: "Sort by modification time".to_string(),
                        takes_value: false,
                        required: false,
                        common: true,
                    },
                ...
                examples: vec![
                    CommandExample {
                        description: "Long listing with hidden files".to_string(),
                        command: "ls -la".to_string(),
                        explanation: None,
                    },
                    CommandExample {
                        description: "Human-readable sizes, sorted by size".to_string(),
                        command: "ls -lhS".to_string(),
                        explanation: None,
                    },
                ],
        ...
        cache.insert(
            ...
            ManPageInfo {
                ...
                common_flags: vec![
                    FlagInfo {
                        flag: "-i".to_string(),
                        long_flag: Some("--ignore-case".to_string()),
                        description: "Ignore case distinctions".to_string(),
                        takes_value: false,
                        required: false,
                        common: true,
                    },
                    FlagInfo {
                        flag: "-r".to_string(),
                        long_flag: Some("--recursive".to_string()),
                        description: "Read all files under each directory recursively".to_string(),
                        takes_value: false,
                        required: false,
                        common: true,
                    },
                    FlagInfo {
                        flag: "-n".to_string(),
                        long_flag: Some("--line-number".to_string()),
                        description: "Prefix each line with its line number".to_string(),
                        takes_value: false,
                        required: false,
                        common: true,
                    },
                    FlagInfo {
                        flag: "-v".to_string(),
                        long_flag: Some("--invert-match".to_string()),
                        description: "Invert the sense of matching".to_string(),
                        takes_value: false,
                        required: false,
                        common: true,
                    },
                    FlagInfo {
                        flag: "-E".to_string(),
                        long_flag: Some("--extended-regexp".to_string()),
                        description: "Use extended regular expressions".to_string(),
                        takes_value: false,
                        required: false,
                        common: true,
                    },
                ...
                examples: vec![
                    CommandExample {
                        description: "Case-insensitive recursive search".to_string(),
                        command: "grep -ri 'pattern' /path".to_string(),
                        explanation: None,
                    },
                    CommandExample {
                        description: "Show line numbers".to_string(),
                        command: "grep -n 'TODO' *.py".to_string(),
                        explanation: None,
                    },
                ],
                see_also: vec![
        ...
        cache.insert(
            ...
            ManPageInfo {
                ...
                description:
                    "OpenSSH remote login client. Connects to a remote host and executes commands."
                        .to_string(),
                common_flags: vec![
                    FlagInfo {
                        flag: "-p".to_string(),
                        long_flag: None,
                        description: "Port to connect to on the remote host".to_string(),
                        takes_value: true,
                        required: false,
                        common: true,
                    },
                    FlagInfo {
                        flag: "-i".to_string(),
                        long_flag: None,
                        description: "Identity file (private key)".to_string(),
                        takes_value: true,
                        required: false,
                        common: true,
                    },
                    FlagInfo {
                        flag: "-L".to_string(),
                        long_flag: None,
                        description: "Local port forwarding".to_string(),
                        takes_value: true,
                        required: false,
                        common: true,
                    },
                    FlagInfo {
                        flag: "-R".to_string(),
                        long_flag: None,
                        description: "Remote port forwarding".to_string(),
                        takes_value: true,
                        required: false,
                        common: true,
                    },
                    FlagInfo {
                        flag: "-D".to_string(),
                        long_flag: None,
                        description: "Dynamic port forwarding (SOCKS proxy)".to_string(),
                        takes_value: true,
                        required: false,
                        common: true,
                    },
                    FlagInfo {
                        flag: "-N".to_string(),
                        long_flag: None,
                        description: "Do not execute a remote command".to_string(),
                        takes_value: false,
                        required: false,
                        common: true,
                    },
                    ...
                    FlagInfo {
                        flag: "-J".to_string(),
                        long_flag: None,
                        description: "Connect through a jump host".to_string(),
                        takes_value: true,
                        required: false,
                        common: true,
                    },
                ...
                examples: vec![
                    CommandExample {
                        description: "Connect on a different port".to_string(),
                        command: "ssh -p 2222 user@host".to_string(),
                        explanation: None,
                    },
                    CommandExample {
                        description: "Port forwarding".to_string(),
                        command: "ssh -L 8080:localhost:80 user@host".to_string(),
                        explanation: Some("Forward local port 8080 to remote port 80".to_string()),
                    },
                    CommandExample {
                        description: "SOCKS proxy".to_string(),
                        command: "ssh -D 1080 user@host".to_string(),
                        explanation: Some("Create a SOCKS proxy on local port 1080".to_string()),
                    },
                    CommandExample {
                        description: "Jump host".to_string(),
                        command: "ssh -J jumpuser@jump target-user@target".to_string(),
                        explanation: None,
                    },
                ],
                see_also: vec![
        ...
        cache.insert(
            ...
            ManPageInfo {
                ...
                common_flags: vec![
                    ...
                    FlagInfo {
                        flag: "-H".to_string(),
                        long_flag: Some("--host".to_string()),
                        description: "Daemon socket(s) to connect to".to_string(),
                        takes_value: true,
                        required: false,
                        common: false,
                    },
                ...
                examples: vec![
                    CommandExample {
                        description: "Run a container interactively".to_string(),
                        command: "docker run -it ubuntu bash".to_string(),
                        explanation: None,
                    },
                    CommandExample {
            ...
            ManPageInfo {
                ...
                common_flags: vec![
                    ...
                    FlagInfo {
                        ...
                        long_flag: None,
                        description: "Print the git version".to_string(),
                        takes_value: false,
                        required: false,
                        common: true,
                    },
                ...
                examples: vec![
                    CommandExample {
                        ...
                        command: "git clone https://github.com/user/repo.git".to_string(),
                        explanation: None,
                    },
                    CommandExample {
                        description: "Stage and commit".to_string(),
                        command: "git add . && git commit -m 'message'".to_string(),
                        explanation: None,
                    },
                    CommandExample {
                        description: "Interactive rebase".to_string(),
                        command: "git rebase -i HEAD~3".to_string(),
                        explanation: Some("Rewrite the last 3 commits".to_string()),
                    },
                ],
                see_also: vec![
                    "git-log".to_string(),
            ...
            ManPageInfo {
                ...
                common_flags: vec![
                    ...
                    FlagInfo {
                        flag: "-type".to_string(),
                        long_flag: None,
                        description: "File type (f=file, d=directory, l=symlink)".to_string(),
                        takes_value: true,
                        required: false,
                        common: true,
                    },
                    FlagInfo {
                        flag: "-size".to_string(),
                        long_flag: None,
                        description: "File size (+n=greater, -n=less)".to_string(),
                        takes_value: true,
                        required: false,
                        common: true,
                    },
                    FlagInfo {
                        ...
                        long_flag: None,
                        description: "Modified within n days".to_string(),
                        takes_value: true,
                        required: false,
                        common: true,
                    },
                    FlagInfo {
                        flag: "-exec".to_string(),
                        long_flag: None,
                        description: "Execute command on each result".to_string(),
                        takes_value: true,
                        required: false,
                        common: true,
                    },
                    FlagInfo {
                        flag: "-maxdepth".to_string(),
                        long_flag: None,
                ...
                examples: vec![
                    CommandExample {
                        description: "Find all .log files".to_string(),
                        command: "find /var/log -name '*.log' -type f".to_string(),
                        explanation: None,
                    },
                    CommandExample {
                        description: "Find large files".to_string(),
                        command: "find / -size +100M -type f 2>/dev/null".to_string(),
                        explanation: None,
                    },
                    CommandExample {
                        description: "Find and delete old files".to_string(),
                        command: "find /tmp -mtime +30 -delete".to_string(),
                        explanation: Some("Delete files in /tmp older than 30 days".to_string()),
                    },
                ],
        ...
        cache.insert(
            ...
            ManPageInfo {
                ...
                common_flags: vec![
                    FlagInfo {
                        flag: "-c".to_string(),
                        long_flag: Some("--create".to_string()),
                        description: "Create a new archive".to_string(),
                        takes_value: false,
                        required: false,
                        common: true,
                    },
                    FlagInfo {
                        flag: "-x".to_string(),
                        long_flag: Some("--extract".to_string()),
                        description: "Extract files from an archive".to_string(),
                        takes_value: false,
                        required: false,
                        common: true,
                    },
                    FlagInfo {
                        flag: "-z".to_string(),
                        long_flag: Some("--gzip".to_string()),
                        description: "Filter through gzip".to_string(),
                        takes_value: false,
                        required: false,
                        common: true,
                    },
                    FlagInfo {
                        ...
                        description: "Verbosely list files processed".to_string(),
                        takes_value: false,
                        required: false,
                        common: true,
                    },
                    FlagInfo {
                        flag: "-f".to_string(),
                        long_flag: Some("--file".to_string()),
                        description: "Use archive file".to_string(),
                        takes_value: true,
                        required: true,
                        common: true,
                    },
                ...
                examples: vec![
                    CommandExample {
                        description: "Create a gzipped archive".to_string(),
                        command: "tar -czf archive.tar.gz /path/to/dir".to_string(),
                        explanation: None,
                    },
                    CommandExample {
                        description: "Extract an archive".to_string(),
                        command: "tar -xzf archive.tar.gz".to_string(),
                        explanation: None,
                    },
                    CommandExample {
                        description: "List archive contents".to_string(),
                        command: "tar -tzf archive.tar.gz".to_string(),
                        explanation: None,
                    },
                ],
