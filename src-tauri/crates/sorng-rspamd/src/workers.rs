        ...
        if let Some(arr) = workers_val.as_array() {
            ...
            for (id, info) in obj {
                workers.push(RspamdWorker {
                    ...
                    status: info.get("status").and_then(|v| v.as_str()).map(String::from),
                });
            }
        }
        ...
        if let Some(arr) = raw.as_array() {
            for item in arr {
                neighbours.push(RspamdNeighbour {
                    ...
                    is_self: item.get("self").or_else(|| item.get("is_self")).and_then(|v| v.as_bool()),
                });
            }
            ...
            for (name, info) in obj {
                neighbours.push(RspamdNeighbour {
                    ...
                    is_self: info.get("self").or_else(|| info.get("is_self")).and_then(|v| v.as_bool()),
                });
            }
        }
