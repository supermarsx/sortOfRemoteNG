...
impl Default for MailcowService {
    fn default() -> Self {
        Self::new()
    }
}
...
impl MailcowService {
    ...
    pub async fn list_mailboxes_by_domain(
        &self,
        id: &str,
        domain: &str,
    ...
    pub async fn update_domain_alias(
        &self,
        id: &str,
        alias_domain: &str,
        active: bool,
    ...
    pub async fn get_transport_map(
        &self,
        id: &str,
        transport_id: i64,
    ) -> MailcowResult<MailcowTransportMap> {
        TransportManager::get(self.client(id)?, transport_id).await
    }

    pub async fn create_transport_map(
        &self,
        id: &str,
    ...
    pub async fn update_transport_map(
        &self,
        id: &str,
        transport_id: i64,
        req: &CreateTransportMapRequest,
    ...
    pub async fn delete_transport_map(
        &self,
        id: &str,
        transport_id: i64,
    ) -> MailcowResult<serde_json::Value> {
    ...
    pub async fn super_delete_queue(
        &self,
        id: &str,
        queue_name: &str,
    ) -> MailcowResult<serde_json::Value> {
    ...
    pub async fn get_quarantine(
        ...
        id: &str,
        quarantine_id: i64,
    ) -> MailcowResult<MailcowQuarantineItem> {
