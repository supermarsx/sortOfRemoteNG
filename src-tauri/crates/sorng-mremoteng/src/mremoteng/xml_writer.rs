...
pub fn write_xml(file: &MrngConnectionFile, master_password: &str) -> MremotengResult<String> {
    ...
    root.push_attribute((
        "KdfIterations",
        &*file.encryption.kdf_iterations.to_string(),
    ));
    root.push_attribute((
        "FullFileEncryption",
        bool_str(file.encryption.full_file_encryption),
    ));
...
fn write_node<W: std::io::Write>(
    ...
    elem.push_attribute((
        ...
        &*u32_str(node.connection_frame_color as u32),
    ));
    ...
    elem.push_attribute((
        ...
        node.ssh_tunnel_connection_name.as_str(),
    ));
    ...
    elem.push_attribute((
        ...
        &*u32_str(node.external_credential_provider as u32),
    ));
    ...
    elem.push_attribute((
        ...
        &*u32_str(node.external_address_provider as u32),
    ));
    ...
    elem.push_attribute((
        ...
        &*node.rdp_minutes_to_idle_timeout.to_string(),
    ));
    ...
    elem.push_attribute((
        ...
        node.rd_gateway_access_token.as_str(),
    ));
    elem.push_attribute((
        "RDGatewayExternalCredentialProvider",
        &*u32_str(node.rd_gateway_external_credential_provider as u32),
    ));
    ...
    elem.push_attribute((
        ...
        bool_str(node.enable_desktop_composition),
    ));
    elem.push_attribute((
        "DisableFullWindowDrag",
        bool_str(node.disable_full_window_drag),
    ));
    elem.push_attribute((
        "DisableMenuAnimations",
        bool_str(node.disable_menu_animations),
    ));
    elem.push_attribute(("DisableCursorShadow", bool_str(node.disable_cursor_shadow)));
    elem.push_attribute((
        "DisableCursorBlinking",
        bool_str(node.disable_cursor_blinking),
    ));
    ...
    elem.push_attribute((
        ...
        node.redirect_disk_drives_custom.as_str(),
    ));
    ...
    elem.push_attribute((
        ...
        bool_str(node.redirect_audio_capture),
    ));
    ...
    elem.push_attribute((
        ...
        node.rdp_start_program_work_dir.as_str(),
    ));
...
fn write_inheritance_attrs(elem: &mut BytesStart, inh: &MrngInheritance) {
    ...
    elem.push_attribute((
        ...
        bool_str(inh.enable_font_smoothing),
    ));
    elem.push_attribute((
        "InheritEnableDesktopComposition",
        bool_str(inh.enable_desktop_composition),
    ));
    elem.push_attribute((
        "InheritDisableFullWindowDrag",
        bool_str(inh.disable_full_window_drag),
    ));
    elem.push_attribute((
        "InheritDisableMenuAnimations",
        bool_str(inh.disable_menu_animations),
    ));
    elem.push_attribute((
        "InheritDisableCursorShadow",
        bool_str(inh.disable_cursor_shadow),
    ));
    elem.push_attribute((
        "InheritDisableCursorBlinking",
        bool_str(inh.disable_cursor_blinking),
    ));
    ...
    elem.push_attribute((
        ...
        bool_str(inh.rdp_authentication_level),
    ));
    elem.push_attribute((
        "InheritRDPMinutesToIdleTimeout",
        bool_str(inh.rdp_minutes_to_idle_timeout),
    ));
    elem.push_attribute((
        "InheritRDPAlertIdleTimeout",
        bool_str(inh.rdp_alert_idle_timeout),
    ));
    elem.push_attribute(("InheritLoadBalanceInfo", bool_str(inh.load_balance_info)));
    elem.push_attribute((
        "InheritRedirectDiskDrives",
        bool_str(inh.redirect_disk_drives),
    ));
    elem.push_attribute((
        "InheritRedirectDiskDrivesCustom",
        bool_str(inh.redirect_disk_drives_custom),
    ));
    ...
    elem.push_attribute((
        ...
        bool_str(inh.redirect_smart_cards),
    ));
    ...
    elem.push_attribute((
        ...
        bool_str(inh.redirect_audio_capture),
    ));
    ...
    elem.push_attribute((
        ...
        bool_str(inh.ssh_tunnel_connection_name),
    ));
    ...
    elem.push_attribute((
        ...
        bool_str(inh.rdp_start_program_work_dir),
    ));
