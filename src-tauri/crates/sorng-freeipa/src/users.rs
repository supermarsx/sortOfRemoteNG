...
impl UserManager {
    ...
    pub async fn create_user(
        ...
        map.insert("givenname".into(), serde_json::json!(req.givenname));
        map.insert("sn".into(), serde_json::json!(req.sn));
        ...
        let result = client
            .rpc::<IpaUser>("user_add", vec![serde_json::json!(req.uid)], serde_json::Value::Object(map))
            .await?;
        Ok(result.result)
    }
    ...
    pub async fn modify_user(
        ...
        let result = client
            .rpc::<IpaUser>("user_mod", vec![serde_json::json!(uid)], serde_json::Value::Object(map))
            .await?;
        Ok(result.result)
    }
