...
impl HostManager {
    ...
    pub async fn create_host(
        ...
        let result = client
            .rpc::<IpaHost>("host_add", vec![serde_json::json!(req.fqdn)], serde_json::Value::Object(map))
            .await?;
        Ok(result.result)
    }
    ...
    pub async fn modify_host(
        ...
        let result = client
            .rpc::<IpaHost>("host_mod", vec![serde_json::json!(fqdn)], serde_json::Value::Object(map))
            .await?;
        Ok(result.result)
    }
