...
impl RbacManager {
    ...
    pub async fn add_role_privilege(
        client: &FreeIpaClient,
        cn: &str,
        privilege: &str,
    ) -> FreeIpaResult<MemberResult> {
    ...
    pub async fn remove_role_privilege(
        client: &FreeIpaClient,
        cn: &str,
        privilege: &str,
    ) -> FreeIpaResult<MemberResult> {
    ...
    pub async fn add_privilege_permission(
        client: &FreeIpaClient,
        cn: &str,
        permission: &str,
    ) -> FreeIpaResult<MemberResult> {
    ...
    pub async fn remove_privilege_permission(
        client: &FreeIpaClient,
        cn: &str,
        permission: &str,
    ) -> FreeIpaResult<MemberResult> {
