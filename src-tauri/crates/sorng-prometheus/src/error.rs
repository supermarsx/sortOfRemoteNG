...
impl PrometheusError {
    ...
    pub fn query_error(msg: impl Into<String>) -> Self {
        Self::new(PrometheusErrorKind::QueryError, msg)
    }
    ...
    pub fn silence_not_found(msg: impl Into<String>) -> Self {
        Self::new(PrometheusErrorKind::SilenceNotFound, msg)
    }
    pub fn config_error(msg: impl Into<String>) -> Self {
        Self::new(PrometheusErrorKind::ConfigError, msg)
    }
    pub fn tsdb_error(msg: impl Into<String>) -> Self {
    ...
    pub fn http(msg: impl Into<String>) -> Self {
        Self::new(PrometheusErrorKind::HttpError, msg)
    }
