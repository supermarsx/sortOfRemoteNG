...
#[tauri::command]
pub async fn exchange_disconnect(
    state: State<'_, ExchangeServiceState>,
) -> Result<(), String> {
...
#[tauri::command]
pub async fn exchange_is_connected(
    state: State<'_, ExchangeServiceState>,
) -> Result<bool, String> {
...
pub async fn exchange_list_mail_contacts(
    ...
    state.lock().await.list_mail_contacts(result_size).await.map_err(err_str)
}
...
pub async fn exchange_get_mail_contact(
    ...
    state.lock().await.get_mail_contact(&identity).await.map_err(err_str)
}
...
pub async fn exchange_create_mail_contact(
    ...
    state.lock().await.create_mail_contact(request).await.map_err(err_str)
}
...
pub async fn exchange_update_mail_contact(
    ...
    state.lock().await.update_mail_contact(&identity, params).await.map_err(err_str)
}
...
pub async fn exchange_remove_mail_contact(
    ...
    state.lock().await.remove_mail_contact(&identity).await.map_err(err_str)
}
...
pub async fn exchange_list_mail_users(
    ...
    state.lock().await.list_mail_users(result_size).await.map_err(err_str)
}
...
pub async fn exchange_get_mail_user(
    ...
    state.lock().await.get_mail_user(&identity).await.map_err(err_str)
}
...
pub async fn exchange_create_mail_user(
    ...
    state.lock().await.create_mail_user(request).await.map_err(err_str)
}
...
pub async fn exchange_remove_mail_user(
    ...
    state.lock().await.remove_mail_user(&identity).await.map_err(err_str)
}
...
pub async fn exchange_list_room_mailboxes(
    ...
    state.lock().await.list_room_mailboxes().await.map_err(err_str)
}
...
pub async fn exchange_list_equipment_mailboxes(
    ...
    state.lock().await.list_equipment_mailboxes().await.map_err(err_str)
}
...
pub async fn exchange_add_automapping(
    ...
    state.lock().await.add_automapping(&mailbox, &user).await.map_err(err_str)
}
...
pub async fn exchange_remove_automapping(
    ...
    state.lock().await.remove_automapping(&mailbox, &user).await.map_err(err_str)
}
...
pub async fn exchange_add_send_as(
    ...
    state.lock().await.add_send_as(&mailbox, &trustee).await.map_err(err_str)
}
...
pub async fn exchange_remove_send_as(
    ...
    state.lock().await.remove_send_as(&mailbox, &trustee).await.map_err(err_str)
}
...
pub async fn exchange_add_send_on_behalf(
    ...
    state.lock().await.add_send_on_behalf(&mailbox, &trustee).await.map_err(err_str)
}
...
pub async fn exchange_remove_send_on_behalf(
    ...
    state.lock().await.remove_send_on_behalf(&mailbox, &trustee).await.map_err(err_str)
}
...
pub async fn exchange_get_archive_info(
    ...
    state.lock().await.get_archive_info(&identity).await.map_err(err_str)
}
...
pub async fn exchange_disable_archive(
    ...
    state.lock().await.disable_archive(&identity).await.map_err(err_str)
}
...
pub async fn exchange_enable_auto_expanding_archive(
    ...
    state.lock().await.enable_auto_expanding_archive(&identity).await.map_err(err_str)
}
...
pub async fn exchange_get_archive_statistics(
    ...
    state.lock().await.get_archive_statistics(&identity).await.map_err(err_str)
}
...
pub async fn exchange_list_mobile_devices(
    ...
    state.lock().await.list_mobile_devices(&mailbox).await.map_err(err_str)
}
...
pub async fn exchange_get_mobile_device_statistics(
    ...
    state.lock().await.get_mobile_device_statistics(&identity).await.map_err(err_str)
}
...
pub async fn exchange_wipe_mobile_device(
    ...
    state.lock().await.wipe_mobile_device(&identity).await.map_err(err_str)
}
...
pub async fn exchange_block_mobile_device(
    ...
    state.lock().await.block_mobile_device(&identity).await.map_err(err_str)
}
...
pub async fn exchange_allow_mobile_device(
    ...
    state.lock().await.allow_mobile_device(&identity).await.map_err(err_str)
}
...
pub async fn exchange_remove_mobile_device(
    ...
    state.lock().await.remove_mobile_device(&identity).await.map_err(err_str)
}
...
pub async fn exchange_list_inbox_rules(
    ...
    state.lock().await.list_inbox_rules(&mailbox).await.map_err(err_str)
}
...
pub async fn exchange_get_inbox_rule(
    ...
    state.lock().await.get_inbox_rule(&mailbox, &rule_id).await.map_err(err_str)
}
...
pub async fn exchange_create_inbox_rule(
    ...
    state.lock().await.create_inbox_rule(request).await.map_err(err_str)
}
...
pub async fn exchange_update_inbox_rule(
    ...
    state.lock().await.update_inbox_rule(&mailbox, &rule_id, params).await.map_err(err_str)
}
...
pub async fn exchange_remove_inbox_rule(
    ...
    state.lock().await.remove_inbox_rule(&mailbox, &rule_id).await.map_err(err_str)
}
...
pub async fn exchange_enable_inbox_rule(
    ...
    state.lock().await.enable_inbox_rule(&mailbox, &rule_id).await.map_err(err_str)
}
...
pub async fn exchange_disable_inbox_rule(
    ...
    state.lock().await.disable_inbox_rule(&mailbox, &rule_id).await.map_err(err_str)
}
...
pub async fn exchange_list_owa_policies(
    ...
    state.lock().await.list_owa_policies().await.map_err(err_str)
}
...
pub async fn exchange_get_owa_policy(
    ...
    state.lock().await.get_owa_policy(&identity).await.map_err(err_str)
}
...
pub async fn exchange_set_owa_policy(
    ...
    state.lock().await.set_owa_policy(&identity, params).await.map_err(err_str)
}
...
pub async fn exchange_list_mobile_device_policies(
    ...
    state.lock().await.list_mobile_device_policies().await.map_err(err_str)
}
...
pub async fn exchange_get_mobile_device_policy(
    ...
    state.lock().await.get_mobile_device_policy(&identity).await.map_err(err_str)
}
...
pub async fn exchange_set_mobile_device_policy(
    ...
    state.lock().await.set_mobile_device_policy(&identity, params).await.map_err(err_str)
}
...
pub async fn exchange_list_throttling_policies(
    ...
    state.lock().await.list_throttling_policies().await.map_err(err_str)
}
...
pub async fn exchange_get_throttling_policy(
    ...
    state.lock().await.get_throttling_policy(&identity).await.map_err(err_str)
}
...
pub async fn exchange_list_journal_rules(
    ...
    state.lock().await.list_journal_rules().await.map_err(err_str)
}
...
pub async fn exchange_get_journal_rule(
    ...
    state.lock().await.get_journal_rule(&identity).await.map_err(err_str)
}
...
pub async fn exchange_create_journal_rule(
    ...
    state.lock().await.create_journal_rule(request).await.map_err(err_str)
}
...
pub async fn exchange_remove_journal_rule(
    ...
    state.lock().await.remove_journal_rule(&identity).await.map_err(err_str)
}
...
pub async fn exchange_enable_journal_rule(
    ...
    state.lock().await.enable_journal_rule(&identity).await.map_err(err_str)
}
...
pub async fn exchange_disable_journal_rule(
    ...
    state.lock().await.disable_journal_rule(&identity).await.map_err(err_str)
}
...
pub async fn exchange_get_role_group(
    ...
    state.lock().await.get_role_group(&identity).await.map_err(err_str)
}
...
pub async fn exchange_add_role_group_member(
    ...
    state.lock().await.add_role_group_member(&group, &member).await.map_err(err_str)
}
...
pub async fn exchange_remove_role_group_member(
    ...
    state.lock().await.remove_role_group_member(&group, &member).await.map_err(err_str)
}
...
pub async fn exchange_list_management_roles(
    ...
    state.lock().await.list_management_roles().await.map_err(err_str)
}
...
pub async fn exchange_get_management_role(
    ...
    state.lock().await.get_management_role(&identity).await.map_err(err_str)
}
...
pub async fn exchange_list_role_assignments(
    ...
    state.lock().await.list_role_assignments(role, role_assignee).await.map_err(err_str)
}
...
pub async fn exchange_search_admin_audit_log(
    ...
    state.lock().await.search_admin_audit_log(request).await.map_err(err_str)
}
...
pub async fn exchange_get_admin_audit_log_config(
    ...
    state.lock().await.get_admin_audit_log_config().await.map_err(err_str)
}
...
pub async fn exchange_enable_mailbox_audit(
    ...
    state.lock().await.enable_mailbox_audit(&identity).await.map_err(err_str)
}
...
pub async fn exchange_disable_mailbox_audit(
    ...
    state.lock().await.disable_mailbox_audit(&identity).await.map_err(err_str)
}
...
pub async fn exchange_list_remote_domains(
    ...
    state.lock().await.list_remote_domains().await.map_err(err_str)
}
...
pub async fn exchange_get_remote_domain(
    ...
    state.lock().await.get_remote_domain(&identity).await.map_err(err_str)
}
...
pub async fn exchange_create_remote_domain(
    ...
    state.lock().await.create_remote_domain(request).await.map_err(err_str)
}
...
pub async fn exchange_update_remote_domain(
    ...
    state.lock().await.update_remote_domain(&identity, params).await.map_err(err_str)
}
...
pub async fn exchange_remove_remote_domain(
    ...
    state.lock().await.remove_remote_domain(&identity).await.map_err(err_str)
}
...
pub async fn exchange_list_certificates(
    ...
    state.lock().await.list_certificates(server).await.map_err(err_str)
}
...
pub async fn exchange_get_certificate(
    ...
    state.lock().await.get_certificate(&thumbprint, server).await.map_err(err_str)
}
...
pub async fn exchange_enable_certificate(
    ...
    state.lock().await.enable_certificate(&thumbprint, &services, server).await.map_err(err_str)
}
...
pub async fn exchange_remove_certificate(
    ...
    state.lock().await.remove_certificate(&thumbprint, server).await.map_err(err_str)
}
...
pub async fn exchange_new_certificate_request(
    ...
    state.lock().await.new_certificate_request(&subject_name, &domain_names, server).await.map_err(err_str)
}
...
pub async fn exchange_list_owa_virtual_directories(
    ...
    state.lock().await.list_owa_virtual_directories(server).await.map_err(err_str)
}
...
pub async fn exchange_list_ecp_virtual_directories(
    ...
    state.lock().await.list_ecp_virtual_directories(server).await.map_err(err_str)
}
...
pub async fn exchange_list_activesync_virtual_directories(
    ...
    state.lock().await.list_activesync_virtual_directories(server).await.map_err(err_str)
}
...
pub async fn exchange_list_ews_virtual_directories(
    ...
    state.lock().await.list_ews_virtual_directories(server).await.map_err(err_str)
}
...
pub async fn exchange_list_mapi_virtual_directories(
    ...
    state.lock().await.list_mapi_virtual_directories(server).await.map_err(err_str)
}
...
pub async fn exchange_list_autodiscover_virtual_directories(
    ...
    state.lock().await.list_autodiscover_virtual_directories(server).await.map_err(err_str)
}
...
pub async fn exchange_list_powershell_virtual_directories(
    ...
    state.lock().await.list_powershell_virtual_directories(server).await.map_err(err_str)
}
...
pub async fn exchange_list_oab_virtual_directories(
    ...
    state.lock().await.list_oab_virtual_directories(server).await.map_err(err_str)
}
...
pub async fn exchange_set_virtual_directory_urls(
    ...
    state.lock().await.set_virtual_directory_urls(vdir_type, &identity, internal_url, external_url).await.map_err(err_str)
}
...
pub async fn exchange_list_outlook_anywhere(
    ...
    state.lock().await.list_outlook_anywhere(server).await.map_err(err_str)
}
...
pub async fn exchange_get_organization_config(
    ...
    state.lock().await.get_organization_config().await.map_err(err_str)
}
...
pub async fn exchange_set_organization_config(
    ...
    state.lock().await.set_organization_config(params).await.map_err(err_str)
}
...
pub async fn exchange_get_transport_config(
    ...
    state.lock().await.get_transport_config().await.map_err(err_str)
}
...
pub async fn exchange_set_transport_config(
    ...
    state.lock().await.set_transport_config(params).await.map_err(err_str)
}
...
pub async fn exchange_get_content_filter_config(
    ...
    state.lock().await.get_content_filter_config().await.map_err(err_str)
}
...
pub async fn exchange_set_content_filter_config(
    ...
    state.lock().await.set_content_filter_config(params).await.map_err(err_str)
}
...
pub async fn exchange_get_connection_filter_config(
    ...
    state.lock().await.get_connection_filter_config().await.map_err(err_str)
}
...
pub async fn exchange_set_connection_filter_config(
    ...
    state.lock().await.set_connection_filter_config(params).await.map_err(err_str)
}
...
pub async fn exchange_get_sender_filter_config(
    ...
    state.lock().await.get_sender_filter_config().await.map_err(err_str)
}
...
pub async fn exchange_set_sender_filter_config(
    ...
    state.lock().await.set_sender_filter_config(params).await.map_err(err_str)
}
...
pub async fn exchange_list_quarantine_messages(
    ...
    state.lock().await.list_quarantine_messages(page_size, quarantine_type).await.map_err(err_str)
}
...
pub async fn exchange_get_quarantine_message(
    ...
    state.lock().await.get_quarantine_message(&identity).await.map_err(err_str)
}
...
pub async fn exchange_release_quarantine_message(
    ...
    state.lock().await.release_quarantine_message(&identity, release_to_all).await.map_err(err_str)
}
...
pub async fn exchange_delete_quarantine_message(
    ...
    state.lock().await.delete_quarantine_message(&identity).await.map_err(err_str)
}
...
pub async fn exchange_new_mailbox_import_request(
    ...
    state.lock().await.new_mailbox_import_request(&mailbox, &file_path, target_root_folder).await.map_err(err_str)
}
...
pub async fn exchange_new_mailbox_export_request(
    ...
    state.lock().await.new_mailbox_export_request(&mailbox, &file_path, include_folders, exclude_folders).await.map_err(err_str)
}
...
pub async fn exchange_list_mailbox_import_requests(
    ...
    state.lock().await.list_mailbox_import_requests(mailbox).await.map_err(err_str)
}
...
pub async fn exchange_list_mailbox_export_requests(
    ...
    state.lock().await.list_mailbox_export_requests(mailbox).await.map_err(err_str)
}
...
pub async fn exchange_remove_mailbox_import_request(
    ...
    state.lock().await.remove_mailbox_import_request(&identity).await.map_err(err_str)
}
...
pub async fn exchange_remove_mailbox_export_request(
    ...
    state.lock().await.remove_mailbox_export_request(&identity).await.map_err(err_str)
}
