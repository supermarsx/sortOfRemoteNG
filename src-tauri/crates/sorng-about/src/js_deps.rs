...
const PRODUCTION_DEPS: &[(&str, &str, &str, &str)] = &[
    ...
    ("i18next", "26.4.0", "MIT", "Internationalization"),
...
const DEV_DEPS: &[(&str, &str, &str, &str)] = &[
    ...
    ("@next/eslint-plugin-next", "16.3.3", "MIT", "Next.js"),
