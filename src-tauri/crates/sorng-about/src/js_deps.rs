...
const PRODUCTION_DEPS: &[(&str, &str, &str, &str)] = &[
    ...
    ("lucide-react", "1.41.0", "ISC", "React & UI"),
...
const DEV_DEPS: &[(&str, &str, &str, &str)] = &[
    ...
    ("@types/react-dom", "19.2.7", "MIT", "Type Definitions"),
    ("@vitejs/plugin-react", "6.1.1", "MIT", "Build Tooling"),
    ("@vitest/coverage-v8", "4.1.11", "MIT", "Testing"),
    ("@wdio/cli", "9.31.6", "MIT", "Testing"),
    ("@wdio/local-runner", "9.31.6", "MIT", "Testing"),
    ("@wdio/mocha-framework", "9.31.6", "MIT", "Testing"),
