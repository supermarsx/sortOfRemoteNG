...
#[command]
pub async fn about_get_license_text(
    state: State<'_>,
    identifier: String,
) -> Result<Option<LicenseEntry>, String> {
    let svc = state.lock().map_err(|e| e.to_string())?;
...
#[command]
pub async fn about_get_rust_deps_by_category(
    state: State<'_>,
) -> Result<Vec<DependencyCategory>, String> {
    let svc = state.lock().map_err(|e| e.to_string())?;
...
#[command]
pub async fn about_get_js_deps_by_category(
    state: State<'_>,
) -> Result<Vec<DependencyCategory>, String> {
    let svc = state.lock().map_err(|e| e.to_string())?;
...
#[command]
pub async fn about_get_workspace_crates(
    state: State<'_>,
) -> Result<Vec<WorkspaceCrateInfo>, String> {
    let svc = state.lock().map_err(|e| e.to_string())?;
    Ok(svc.get_workspace_crates())
}

#[command]
pub async fn about_get_workspace_crates_by_category(
    state: State<'_>,
) -> Result<Vec<DependencyCategory>, String> {
    let svc = state.lock().map_err(|e| e.to_string())?;
...
#[command]
pub async fn about_search_deps(
    state: State<'_>,
    query: String,
...
#[command]
pub async fn about_get_deps_by_license(
    state: State<'_>,
    license: String,
) -> Result<Vec<DependencyInfo>, String> {
    let svc = state.lock().map_err(|e| e.to_string())?;
