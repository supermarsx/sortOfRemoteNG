...
impl JiraUserManager {
    ...
    pub async fn get(client: &JiraClient, account_id: &str) -> JiraResult<JiraUser> {
        ...
        client
            .get_with_params(&client.api_url("/user"), &params)
            .await
    }
    ...
    pub async fn search(
        ...
        client
            .get_with_params(&client.api_url("/user/search"), &params)
            .await
    }

    pub async fn find_assignable(
        client: &JiraClient,
        project: &str,
        query: Option<&str>,
    ) -> JiraResult<Vec<JiraUser>> {
        ...
        client
            .get_with_params(&client.api_url("/user/assignable/search"), &params)
            .await
    }
    ...
    pub async fn get_groups(
        ...
        let params = vec![("accountId".into(), account_id.to_string())];
        client
            .get_with_params(&client.api_url("/user/groups"), &params)
            .await
    }
}
