...
impl IssueManager {
    ...
    pub async fn bulk_create(
        client: &JiraClient,
        req: &BulkCreateIssueRequest,
    ) -> JiraResult<BulkCreateIssueResponse> {
    ...
    pub async fn update(
        ...
        client
            .put_unit(&client.api_url(&format!("/issue/{}", issue_id_or_key)), req)
            .await
    }
    ...
    pub async fn get_transitions(
        client: &JiraClient,
        issue_id_or_key: &str,
    ) -> JiraResult<Vec<JiraTransition>> {
        #[derive(serde::Deserialize)]
        struct Wrap {
            transitions: Vec<JiraTransition>,
        }
        let w: Wrap = client
            .get(&client.api_url(&format!("/issue/{}/transitions", issue_id_or_key)))
            .await?;
        Ok(w.transitions)
    }
    ...
    pub async fn transition(
        ...
        client
            .post_unit(
                &client.api_url(&format!("/issue/{}/transitions", issue_id_or_key)),
                req,
            )
            .await
    }
    ...
    pub async fn assign(
        ...
        client
            .put_unit(
                &client.api_url(&format!("/issue/{}/assignee", issue_id_or_key)),
                &body,
            )
            .await
    }
    ...
    pub async fn get_changelog(
        client: &JiraClient,
        issue_id_or_key: &str,
    ) -> JiraResult<Vec<JiraChangelogEntry>> {
        let issue: JiraIssue = client
            .get(&format!(
                "{}?expand=changelog",
                client.api_url(&format!("/issue/{}", issue_id_or_key))
            ))
            .await?;
    ...
    pub async fn get_watchers(
        client: &JiraClient,
        issue_id_or_key: &str,
    ) -> JiraResult<Vec<JiraUser>> {
        #[derive(serde::Deserialize)]
        struct Wrap {
            watchers: Vec<JiraUser>,
        }
        let w: Wrap = client
            .get(&client.api_url(&format!("/issue/{}/watchers", issue_id_or_key)))
            .await?;
        Ok(w.watchers)
    }
    ...
    pub async fn add_watcher(
        ...
        client
            .post_unit(
                &client.api_url(&format!("/issue/{}/watchers", issue_id_or_key)),
