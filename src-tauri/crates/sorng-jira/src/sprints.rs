...
impl SprintManager {
    pub async fn list(
        ...
        client
            .get_with_params(
                &client.agile_url(&format!("/board/{}/sprint", board_id)),
                &params,
            )
            .await
    }
    ...
    pub async fn get(client: &JiraClient, sprint_id: i64) -> JiraResult<JiraSprint> {
        client
            .get(&client.agile_url(&format!("/sprint/{}", sprint_id)))
            .await
    }
    ...
    pub async fn update(
        ...
        client
            .put(&client.agile_url(&format!("/sprint/{}", sprint_id)), req)
            .await
    }

    pub async fn delete(client: &JiraClient, sprint_id: i64) -> JiraResult<()> {
        client
            .delete(&client.agile_url(&format!("/sprint/{}", sprint_id)))
            .await
    }
    ...
    pub async fn get_issues(
        ...
        client
            .get_with_params(
                &client.agile_url(&format!("/sprint/{}/issue", sprint_id)),
                &params,
            )
            .await
    }
