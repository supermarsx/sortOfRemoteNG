...
impl DashboardManager {
    pub async fn list(client: &JiraClient, start_at: Option<u32>, max_results: Option<u32>) -> JiraResult<DashboardsResponse> {
