...
#[tauri::command]
pub async fn ai_check_provider_health(
    state: State<'_, AiAgentServiceState>,
    id: String,
...
#[tauri::command]
pub async fn ai_pin_conversation(
    state: State<'_, AiAgentServiceState>,
    id: String,
    pinned: bool,
) -> Result<(), String> {
...
#[tauri::command]
pub async fn ai_archive_conversation(
    state: State<'_, AiAgentServiceState>,
    id: String,
    archived: bool,
) -> Result<(), String> {
...
#[tauri::command]
pub async fn ai_set_conversation_tags(
    state: State<'_, AiAgentServiceState>,
    id: String,
    tags: Vec<String>,
) -> Result<(), String> {
...
#[tauri::command]
pub async fn ai_fork_conversation(
    state: State<'_, AiAgentServiceState>,
...
#[tauri::command]
pub async fn ai_search_conversations(
    state: State<'_, AiAgentServiceState>,
    query: String,
) -> Result<Vec<ConversationSummary>, String> {
    let svc = state.lock().await;
...
#[tauri::command]
pub async fn ai_import_conversation(
    state: State<'_, AiAgentServiceState>,
...
pub async fn ai_code_refactor(
    ...
    let req = CodeAssistRequest {
        provider_id,
        model,
        action: CodeAssistAction::Refactor,
        code,
        language,
        instructions,
        context: Vec::new(),
...
pub async fn ai_code_document(
    ...
    let req = CodeAssistRequest {
        provider_id,
        model,
        action: CodeAssistAction::Document,
        code,
        language,
        instructions: None,
        context: Vec::new(),
...
#[tauri::command]
pub async fn ai_code_find_bugs(
    state: State<'_, AiAgentServiceState>,
    provider_id: String,
    model: String,
    code: String,
    ...
    let req = CodeAssistRequest {
        provider_id,
        model,
        action: CodeAssistAction::FindBugs,
        code,
        language,
        instructions: None,
        context: Vec::new(),
...
pub async fn ai_code_optimize(
    ...
    let req = CodeAssistRequest {
        provider_id,
        model,
        action: CodeAssistAction::Optimize,
        code,
        language,
        instructions: None,
        context: Vec::new(),
...
#[tauri::command]
pub async fn ai_code_write_tests(
    state: State<'_, AiAgentServiceState>,
    provider_id: String,
    model: String,
    code: String,
...
pub async fn ai_code_convert(
    ...
    let req = CodeAssistRequest {
        provider_id,
        model,
        action: CodeAssistAction::ConvertLanguage,
        code,
...
#[tauri::command]
pub async fn ai_code_fix_error(
    state: State<'_, AiAgentServiceState>,
    provider_id: String,
    model: String,
    code: String,
    ...
    let req = CodeAssistRequest {
        provider_id,
        model,
        action: CodeAssistAction::FixError,
        code,
        language,
        instructions: Some(format!("Fix this error: {}", error_message)),
        context: Vec::new(),
        params: InferenceParams::default(),
    };
    let mut svc = state.lock().await;
...
#[tauri::command]
pub async fn ai_list_memory(
    state: State<'_, AiAgentServiceState>,
    namespace: Option<String>,
) -> Result<Vec<MemoryEntry>, String> {
    let svc = state.lock().await;
    Ok(svc
        .list_memory_entries(namespace.as_deref())
        .into_iter()
        .cloned()
        .collect())
}
...
#[tauri::command]
pub async fn ai_get_memory_config(
    state: State<'_, AiAgentServiceState>,
...
#[tauri::command]
pub async fn ai_update_memory_config(
    state: State<'_, AiAgentServiceState>,
    config: MemoryConfig,
) -> Result<(), String> {
    let mut svc = state.lock().await;
...
#[tauri::command]
pub async fn ai_search_vectors(
    state: State<'_, AiAgentServiceState>,
...
#[tauri::command]
pub async fn ai_ingest_document(
    state: State<'_, AiAgentServiceState>,
...
#[tauri::command]
pub async fn ai_remove_document(
    state: State<'_, AiAgentServiceState>,
    doc_id: String,
) -> Result<bool, String> {
    let mut svc = state.lock().await;
...
#[tauri::command]
pub async fn ai_list_rag_collections(
    state: State<'_, AiAgentServiceState>,
...
#[tauri::command]
pub async fn ai_delete_workflow(
    state: State<'_, AiAgentServiceState>,
    id: String,
) -> Result<bool, String> {
    let mut svc = state.lock().await;
...
#[tauri::command]
pub async fn ai_list_workflows(
    state: State<'_, AiAgentServiceState>,
...
#[tauri::command]
pub async fn ai_get_budget_status(
    state: State<'_, AiAgentServiceState>,
...
pub async fn ai_diagnostics(
    state: State<'_, AiAgentServiceState>,
) -> Result<AiDiagnosticsReport, String> {
    let svc = state.lock().await;
