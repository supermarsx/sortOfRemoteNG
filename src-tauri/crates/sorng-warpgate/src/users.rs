...
impl UserManager {
    ...
    pub async fn add_role(
        ...
        client
            .post_empty(&format!("/users/{}/roles/{}", user_id, role_id))
            .await?;
        Ok(())
    }
    ...
    pub async fn remove_role(
        ...
        client
            .delete(&format!("/users/{}/roles/{}", user_id, role_id))
            .await?;
        Ok(())
    }

    /// POST /users/:id/ldap-link/unlink
    pub async fn unlink_ldap(
        client: &WarpgateClient,
        user_id: &str,
    ) -> WarpgateResult<WarpgateUser> {
        let resp = client
            .post_empty(&format!("/users/{}/ldap-link/unlink", user_id))
            .await?;
        let user: WarpgateUser = serde_json::from_value(resp)?;
        Ok(user)
    }
    ...
    pub async fn auto_link_ldap(
        client: &WarpgateClient,
        user_id: &str,
    ) -> WarpgateResult<WarpgateUser> {
        let resp = client
            .post_empty(&format!("/users/{}/ldap-link/auto-link", user_id))
            .await?;
        let user: WarpgateUser = serde_json::from_value(resp)?;
        Ok(user)
    }
