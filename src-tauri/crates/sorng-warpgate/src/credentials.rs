...
impl CredentialManager {
    ...
    pub async fn list_passwords(
        ...
        let resp = client
            .get(&format!("/users/{}/credentials/passwords", user_id))
            .await?;
    ...
    pub async fn create_password(
        ...
        let resp = client
            .post(&format!("/users/{}/credentials/passwords", user_id), &body)
            .await?;
    ...
    pub async fn list_public_keys(
        ...
        let resp = client
            .get(&format!("/users/{}/credentials/public-keys", user_id))
            .await?;
    ...
    pub async fn create_public_key(
        ...
        let resp = client
            .post(
                &format!("/users/{}/credentials/public-keys", user_id),
                &body,
            )
            .await?;
    ...
    pub async fn update_public_key(
        ...
        let resp = client
            .put(
                &format!("/users/{}/credentials/public-keys/{}", user_id, cred_id),
                &body,
            )
            .await?;
        let cred: PublicKeyCredential = serde_json::from_value(resp)?;
    ...
    pub async fn list_sso(
        ...
        let resp = client
            .get(&format!("/users/{}/credentials/sso", user_id))
            .await?;
    ...
    pub async fn create_sso(
        ...
        let body = serde_json::to_value(req)?;
        let resp = client
            .post(&format!("/users/{}/credentials/sso", user_id), &body)
            .await?;
    ...
    pub async fn update_sso(
        ...
        let resp = client
            .put(
                &format!("/users/{}/credentials/sso/{}", user_id, cred_id),
                &body,
            )
            .await?;
        let cred: SsoCredential = serde_json::from_value(resp)?;
    ...
    pub async fn delete_sso(
        ...
        client
            .delete(&format!("/users/{}/credentials/sso/{}", user_id, cred_id))
            .await?;
        Ok(())
    }
    ...
    pub async fn list_otp(
        client: &WarpgateClient,
        user_id: &str,
    ) -> WarpgateResult<Vec<OtpCredential>> {
        let resp = client
            .get(&format!("/users/{}/credentials/otp", user_id))
            .await?;
    ...
    pub async fn create_otp(
        ...
        let body = serde_json::to_value(req)?;
        let resp = client
            .post(&format!("/users/{}/credentials/otp", user_id), &body)
            .await?;
    ...
    pub async fn delete_otp(
        ...
        client
            .delete(&format!("/users/{}/credentials/otp/{}", user_id, cred_id))
            .await?;
        Ok(())
    }
    ...
    pub async fn list_certificates(
        ...
        let resp = client
            .get(&format!("/users/{}/credentials/certificates", user_id))
            .await?;
    ...
    pub async fn issue_certificate(
        ...
        let resp = client
            .post(
                &format!("/users/{}/credentials/certificates", user_id),
                &body,
            )
            .await?;
    ...
    pub async fn update_certificate(
        ...
        let resp = client
            .patch(
                &format!("/users/{}/credentials/certificates/{}", user_id, cred_id),
                &body,
            )
            .await?;
    ...
    pub async fn revoke_certificate(
        ...
        client
            .delete(&format!(
                "/users/{}/credentials/certificates/{}",
                user_id, cred_id
            ))
            .await?;
        Ok(())
