...
#[tauri::command]
pub async fn apache_disconnect(
    state: State<'_, ApacheServiceState>,
    id: String,
) -> CmdResult<()> {
...
pub async fn apache_get_vhost(
    ...
    state.lock().await.get_vhost(&id, &name).await.map_err(map_err)
}
...
pub async fn apache_create_vhost(
    ...
    state.lock().await.create_vhost(&id, request).await.map_err(map_err)
}
...
pub async fn apache_update_vhost(
    ...
    state.lock().await.update_vhost(&id, &name, request).await.map_err(map_err)
}
...
pub async fn apache_delete_vhost(
    ...
    state.lock().await.delete_vhost(&id, &name).await.map_err(map_err)
}
...
pub async fn apache_enable_vhost(
    ...
    state.lock().await.enable_vhost(&id, &name).await.map_err(map_err)
}
...
pub async fn apache_disable_vhost(
    ...
    state.lock().await.disable_vhost(&id, &name).await.map_err(map_err)
}
...
pub async fn apache_list_available_modules(
    ...
    state.lock().await.list_available_modules(&id).await.map_err(map_err)
}
...
pub async fn apache_list_enabled_modules(
    ...
    state.lock().await.list_enabled_modules(&id).await.map_err(map_err)
}
...
pub async fn apache_enable_module(
    ...
    state.lock().await.enable_module(&id, &name).await.map_err(map_err)
}
...
pub async fn apache_disable_module(
    ...
    state.lock().await.disable_module(&id, &name).await.map_err(map_err)
}
...
pub async fn apache_get_ssl_config(
    ...
    state.lock().await.get_ssl_config(&id, &vhost_name).await.map_err(map_err)
}
...
pub async fn apache_list_conf_available(
    ...
    state.lock().await.list_conf_available(&id).await.map_err(map_err)
}
...
pub async fn apache_list_conf_enabled(
    ...
    state.lock().await.list_conf_enabled(&id).await.map_err(map_err)
}
...
pub async fn apache_enable_conf(
    ...
    state.lock().await.enable_conf(&id, &name).await.map_err(map_err)
}
...
pub async fn apache_disable_conf(
    ...
    state.lock().await.disable_conf(&id, &name).await.map_err(map_err)
}

// ── Process ───────────────────────────────────────────────────────

#[tauri::command]
pub async fn apache_start(
    state: State<'_, ApacheServiceState>,
    id: String,
) -> CmdResult<()> {
