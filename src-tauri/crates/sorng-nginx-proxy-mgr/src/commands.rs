...
#[tauri::command]
pub async fn npm_list_connections(state: State<'_, NpmServiceState>) -> CmdResult<Vec<String>> {
...
pub async fn npm_update_proxy_host(
    ...
    state
        .lock()
        .await
        .update_proxy_host(&id, host_id, request)
        .await
        .map_err(map_err)
}
...
pub async fn npm_get_redirection_host(
    ...
    state
        .lock()
        .await
        .get_redirection_host(&id, host_id)
        .await
        .map_err(map_err)
}
...
pub async fn npm_create_redirection_host(
    ...
    state
        .lock()
        .await
        .create_redirection_host(&id, request)
        .await
        .map_err(map_err)
}
...
pub async fn npm_update_redirection_host(
    ...
    state
        .lock()
        .await
        .update_redirection_host(&id, host_id, request)
        .await
        .map_err(map_err)
}
...
pub async fn npm_delete_redirection_host(
    ...
    state
        .lock()
        .await
        .delete_redirection_host(&id, host_id)
        .await
        .map_err(map_err)
}
...
pub async fn npm_update_dead_host(
    ...
    state
        .lock()
        .await
        .update_dead_host(&id, host_id, request)
        .await
        .map_err(map_err)
}
...
pub async fn npm_update_stream(
    ...
    state
        .lock()
        .await
        .update_stream(&id, stream_id, request)
        .await
        .map_err(map_err)
}
...
pub async fn npm_create_letsencrypt_certificate(
    ...
    state
        .lock()
        .await
        .create_letsencrypt_certificate(&id, request)
        .await
        .map_err(map_err)
}
...
pub async fn npm_upload_custom_certificate(
    ...
    state
        .lock()
        .await
        .upload_custom_certificate(&id, request)
        .await
        .map_err(map_err)
}
...
pub async fn npm_validate_certificate(
    ...
    state
        .lock()
        .await
        .validate_certificate(&id, cert_id)
        .await
        .map_err(map_err)
}
...
pub async fn npm_change_user_password(
    ...
    state
        .lock()
        .await
        .change_user_password(&id, user_id, request)
        .await
        .map_err(map_err)
}

#[tauri::command]
pub async fn npm_get_me(state: State<'_, NpmServiceState>, id: String) -> CmdResult<NpmUser> {
...
pub async fn npm_update_access_list(
    ...
    state
        .lock()
        .await
        .update_access_list(&id, list_id, request)
        .await
        .map_err(map_err)
}
...
pub async fn npm_update_setting(
    ...
    state
        .lock()
        .await
        .update_setting(&id, &setting_id, value)
        .await
        .map_err(map_err)
}
