...
mod tests {
    ...
    fn parse_info() {
        ...
        let MgmtMessage::Info(s) = msg else {
            unreachable!("Expected MgmtMessage::Info variant")
        };
    ...
    fn parse_state() {
        ...
        let MgmtMessage::State(s) = msg else {
            unreachable!("Expected MgmtMessage::State variant")
        };
    ...
    fn parse_bytecount() {
        ...
        let MgmtMessage::ByteCount { rx, tx } = msg else {
            unreachable!("Expected MgmtMessage::ByteCount variant")
        };
        assert_eq!(rx, 123456);
        assert_eq!(tx, 789012);
    }
    ...
    fn parse_password_needed() {
        ...
        let MgmtMessage::PasswordNeeded(s) = msg else {
            unreachable!("Expected MgmtMessage::PasswordNeeded variant")
        };
    ...
    fn parse_log() {
        ...
        let MgmtMessage::Log(entry) = msg else {
            unreachable!("Expected MgmtMessage::Log variant")
        };
    ...
    fn parse_fatal() {
        ...
        let MgmtMessage::Fatal(s) = msg else {
            unreachable!("Expected MgmtMessage::Fatal variant")
        };
    ...
    fn parse_remote() {
        ...
        let MgmtMessage::Remote { host, port, proto } = msg else {
            unreachable!("Expected MgmtMessage::Remote variant")
        };
    ...
    fn parse_echo() {
        ...
        let MgmtMessage::Echo(s) = msg else {
            unreachable!("Expected MgmtMessage::Echo variant")
        };
    ...
    fn parse_client_event() {
        ...
        let MgmtMessage::ClientEvent(s) = msg else {
            unreachable!("Expected MgmtMessage::ClientEvent variant")
        };
