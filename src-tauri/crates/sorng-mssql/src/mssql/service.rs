...
impl MssqlService {
    ...
    fn validate_sql_identifier(name: &str) -> Result<(), MssqlError> {
    ...
    pub async fn list_tables(
        ...
        id: &str,
        schema: &str,
    ) -> Result<Vec<TableInfo>, MssqlError> {
        let sql = format!(
            "SELECT t.name, s.name AS [schema], t.type_desc AS table_type, \
             ...
             GROUP BY t.name, s.name, t.type_desc, p.rows ORDER BY t.name",
            schema
        );
    ...
    pub async fn describe_table(
        ...
        schema: &str,
        table: &str,
    ) -> Result<Vec<ColumnDef>, MssqlError> {
        let sql = format!(
    ...
    pub async fn list_foreign_keys(
        ...
        schema: &str,
        table: &str,
    ) -> Result<Vec<ForeignKeyInfo>, MssqlError> {
        let sql = format!(
        ...
        Ok(qr
            ...
            .map(|r| ForeignKeyInfo {
                ...
                referenced_schema: r
                    ...
                    .to_string(),
                on_update: r
                    .get("update_referential_action_desc")
                    .and_then(|v| v.as_str())
                    .unwrap_or("")
                    .to_string(),
                on_delete: r
                    .get("delete_referential_action_desc")
                    .and_then(|v| v.as_str())
                    .unwrap_or("")
                    .to_string(),
            })
    ...
    pub async fn list_views(
        ...
        id: &str,
        schema: &str,
    ) -> Result<Vec<ViewInfo>, MssqlError> {
        let sql = format!(
    ...
    pub async fn list_stored_procs(
        &mut self,
        id: &str,
        schema: &str,
    ) -> Result<Vec<StoredProcInfo>, MssqlError> {
        let sql = format!(
    ...
    pub async fn create_database(&mut self, id: &str, name: &str) -> Result<(), MssqlError> {
        self.execute_statement(id, &format!("CREATE DATABASE [{}]", name))
            .await?;
        Ok(())
    }

    pub async fn drop_database(&mut self, id: &str, name: &str) -> Result<(), MssqlError> {
        self.execute_statement(id, &format!("DROP DATABASE IF EXISTS [{}]", name))
            .await?;
        Ok(())
    }
    ...
    pub async fn drop_table(
        ...
        Self::validate_sql_identifier(schema)?;
    ...
    pub async fn truncate_table(
        ...
        Self::validate_sql_identifier(schema)?;
        Self::validate_sql_identifier(table)?;
        self.execute_statement(id, &format!("TRUNCATE TABLE [{}].[{}]", schema, table))
            .await?;
        Ok(())
    }
    ...
    async fn export_table_json(
        ...
        serde_json::to_string_pretty(&all_rows)
            .map_err(|e| MssqlError::new(MssqlErrorKind::ExportFailed, format!("{e}")))
    }
