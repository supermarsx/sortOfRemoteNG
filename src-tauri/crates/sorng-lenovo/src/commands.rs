...
#[tauri::command]
pub async fn lenovo_get_config(
    state: State<'_, LenovoServiceState>,
) -> Result<LenovoConfigSafe, String> {
    let svc = state.lock().await;
...
#[tauri::command]
pub async fn lenovo_get_system_info(
    state: State<'_, LenovoServiceState>,
...
#[tauri::command]
pub async fn lenovo_set_asset_tag(
    state: State<'_, LenovoServiceState>,
    tag: String,
) -> Result<(), String> {
    let svc = state.lock().await;
...
#[tauri::command]
pub async fn lenovo_set_indicator_led(
    state: State<'_, LenovoServiceState>,
    led_state: String,
) -> Result<(), String> {
    let svc = state.lock().await;
...
#[tauri::command]
pub async fn lenovo_power_action(
    state: State<'_, LenovoServiceState>,
    action: String,
) -> Result<(), String> {
...
#[tauri::command]
pub async fn lenovo_get_power_state(
    state: State<'_, LenovoServiceState>,
) -> Result<String, String> {
    let svc = state.lock().await;
...
#[tauri::command]
pub async fn lenovo_get_power_metrics(
    state: State<'_, LenovoServiceState>,
...
#[tauri::command]
pub async fn lenovo_get_thermal_data(
    state: State<'_, LenovoServiceState>,
...
#[tauri::command]
pub async fn lenovo_get_thermal_summary(
    state: State<'_, LenovoServiceState>,
...
#[tauri::command]
pub async fn lenovo_get_processors(
    state: State<'_, LenovoServiceState>,
...
#[tauri::command]
pub async fn lenovo_get_memory(
    state: State<'_, LenovoServiceState>,
...
#[tauri::command]
pub async fn lenovo_get_storage_controllers(
    state: State<'_, LenovoServiceState>,
...
#[tauri::command]
pub async fn lenovo_get_virtual_disks(
    state: State<'_, LenovoServiceState>,
...
#[tauri::command]
pub async fn lenovo_get_physical_disks(
    state: State<'_, LenovoServiceState>,
...
#[tauri::command]
pub async fn lenovo_get_network_adapters(
    state: State<'_, LenovoServiceState>,
...
#[tauri::command]
pub async fn lenovo_get_xcc_network(
    state: State<'_, LenovoServiceState>,
...
#[tauri::command]
pub async fn lenovo_get_firmware_inventory(
    state: State<'_, LenovoServiceState>,
...
#[tauri::command]
pub async fn lenovo_get_virtual_media_status(
    state: State<'_, LenovoServiceState>,
...
#[tauri::command]
pub async fn lenovo_insert_virtual_media(
    state: State<'_, LenovoServiceState>,
    slot: String,
    image_url: String,
) -> Result<(), String> {
...
#[tauri::command]
pub async fn lenovo_eject_virtual_media(
    state: State<'_, LenovoServiceState>,
    slot: String,
) -> Result<(), String> {
    let svc = state.lock().await;
...
#[tauri::command]
pub async fn lenovo_get_console_info(
    state: State<'_, LenovoServiceState>,
) -> Result<XccConsoleInfo, String> {
    let svc = state.lock().await;
    svc.get_console_info().await.map_err(|e| e.to_string())
}

#[tauri::command]
pub async fn lenovo_get_html5_launch_url(
    state: State<'_, LenovoServiceState>,
) -> Result<String, String> {
    let svc = state.lock().await;
...
#[tauri::command]
pub async fn lenovo_get_event_log(
    state: State<'_, LenovoServiceState>,
...
#[tauri::command]
pub async fn lenovo_get_audit_log(
    state: State<'_, LenovoServiceState>,
) -> Result<Vec<BmcEventLogEntry>, String> {
    let svc = state.lock().await;
...
#[tauri::command]
pub async fn lenovo_get_users(
    state: State<'_, LenovoServiceState>,
) -> Result<Vec<BmcUser>, String> {
    let svc = state.lock().await;
    svc.get_users().await.map_err(|e| e.to_string())
}

#[tauri::command]
pub async fn lenovo_create_user(
    state: State<'_, LenovoServiceState>,
    username: String,
    password: String,
    role: String,
...
#[tauri::command]
pub async fn lenovo_update_password(
    state: State<'_, LenovoServiceState>,
    user_id: String,
    password: String,
) -> Result<(), String> {
    let svc = state.lock().await;
    svc.update_password(&user_id, &password)
        .await
        .map_err(|e| e.to_string())
}

#[tauri::command]
pub async fn lenovo_delete_user(
    state: State<'_, LenovoServiceState>,
    user_id: String,
) -> Result<(), String> {
    let svc = state.lock().await;
...
#[tauri::command]
pub async fn lenovo_get_bios_attributes(
    state: State<'_, LenovoServiceState>,
...
#[tauri::command]
pub async fn lenovo_set_bios_attributes(
    state: State<'_, LenovoServiceState>,
...
#[tauri::command]
pub async fn lenovo_get_boot_config(
    state: State<'_, LenovoServiceState>,
...
#[tauri::command]
pub async fn lenovo_set_boot_override(
    state: State<'_, LenovoServiceState>,
    target: String,
    mode: Option<String>,
) -> Result<(), String> {
...
#[tauri::command]
pub async fn lenovo_get_certificate(
    state: State<'_, LenovoServiceState>,
) -> Result<XccCertificate, String> {
    let svc = state.lock().await;
    svc.get_certificate().await.map_err(|e| e.to_string())
}

#[tauri::command]
pub async fn lenovo_generate_csr(
    state: State<'_, LenovoServiceState>,
    params: CsrParams,
) -> Result<String, String> {
    let svc = state.lock().await;
...
#[tauri::command]
pub async fn lenovo_import_certificate(
    state: State<'_, LenovoServiceState>,
    cert_pem: String,
) -> Result<(), String> {
    let svc = state.lock().await;
...
#[tauri::command]
pub async fn lenovo_get_health_rollup(
    state: State<'_, LenovoServiceState>,
...
#[tauri::command]
pub async fn lenovo_get_dashboard(
    state: State<'_, LenovoServiceState>,
) -> Result<XccDashboard, String> {
    let svc = state.lock().await;
...
#[tauri::command]
pub async fn lenovo_get_license(
    _state: State<'_, LenovoServiceState>,
) -> Result<XccLicense, String> {
...
#[tauri::command]
pub async fn lenovo_onecli_execute(
    state: State<'_, LenovoServiceState>,
    command: String,
) -> Result<OnecliResult, String> {
    let svc = state.lock().await;
    svc.onecli_execute(&command)
        .await
        .map_err(|e| e.to_string())
}
