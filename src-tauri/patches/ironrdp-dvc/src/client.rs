    ...
    fn process(&mut self, payload: &[u8]) -> PduResult<Vec<SvcMessage>> {
        ...
        match pdu {
            ...
            DrdynvcServerPdu::Create(create_request) => {
                info!("DVC Create Request: channel_name={:?} channel_id={}", create_request.channel_name(), create_request.channel_id());
                ...
                info!("DVC channel lookup: name={:?} found={}", channel_name, channel_exists);
