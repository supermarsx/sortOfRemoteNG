...
impl ActiveStage {
    ...
    /// Used to preserve SVC processors across deactivation-reactivation sequences.
    pub fn take_static_channels(&mut self) -> ironrdp_svc::StaticChannelSet {
        self.x224_processor.take_static_channels()
    }
