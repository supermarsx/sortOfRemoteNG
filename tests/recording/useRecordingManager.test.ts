...
describe("useRecordingManager", () => {
  beforeEach(() => {
    vi.clearAllMocks();
    (macroService.loadRecordings as Mock).mockResolvedValue([
      ...mockSshRecordings,
    ]);
    (macroService.loadRdpRecordings as Mock).mockResolvedValue([
      ...mockRdpRecordings,
    ]);
    (macroService.loadWebRecordings as Mock).mockResolvedValue([
      ...mockWebRecordings,
    ]);
    (macroService.loadWebVideoRecordings as Mock).mockResolvedValue([
      ...mockWebVideoRecordings,
    ]);
  });
