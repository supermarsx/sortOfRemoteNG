...
describe("RDPStatusBar", () => {
  ...
  it("shows completed presentation FPS when provided", () => {
  ...
  it("does not substitute decoded FPS for an unavailable presentation sample", () => {
    const stats: RDPStatsEvent = {
      session_id: "abc",
      uptime_secs: 120,
      bytes_received: 1024,
    ...
    render(<RDPStatusBar {...baseProps} isConnected stats={stats} />);
    expect(screen.getByText("FPS unavailable")).toBeInTheDocument();
