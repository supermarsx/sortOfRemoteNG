...
describe("SynologyPanel", () => {
  ...
  it("returns null when not open", async () => {
    const { SynologyPanel } = await import(
...
describe("SynologyPanel - TypeScript types", () => {
  it("exports SynologyPanelProps interface", async () => {
    const mod = await import(
      "../src/components/synology/synologyPanel/types"
    );
...
describe("SynologyPanel - useSynologyManager hook", () => {
  it("exports useSynologyManager function", async () => {
    const mod = await import(
      "../src/hooks/synology/useSynologyManager"
    );
...
describe("SynologyPanel - Secondary Views", () => {
  it("exports all secondary view components", async () => {
    const views = await import(
      "../src/components/synology/synologyPanel/SecondaryViews"
    );
...
describe("SynologyPanel - standalone views", () => {
  it("exports DashboardView", async () => {
    const mod = await import(
      "../src/components/synology/synologyPanel/DashboardView"
    );
  ...
  it("exports SystemView", async () => {
    const mod = await import(
      "../src/components/synology/synologyPanel/SystemView"
    );
    expect(mod.default).toBeDefined();
  });
  ...
  it("exports StorageView", async () => {
    const mod = await import(
      "../src/components/synology/synologyPanel/StorageView"
    );
    expect(mod.default).toBeDefined();
  });
  ...
  it("exports FileStationView", async () => {
    const mod = await import(
      "../src/components/synology/synologyPanel/FileStationView"
    );
    expect(mod.default).toBeDefined();
  });
  ...
  it("exports Sidebar", async () => {
    const mod = await import(
      "../src/components/synology/synologyPanel/Sidebar"
    );
    expect(mod.default).toBeDefined();
  });
  ...
  it("exports ConnectionForm", async () => {
    const mod = await import(
      "../src/components/synology/synologyPanel/ConnectionForm"
    );
    expect(mod.default).toBeDefined();
  });
  ...
  it("exports SynologyHeader", async () => {
    const mod = await import(
      "../src/components/synology/synologyPanel/SynologyHeader"
    );
    expect(mod.default).toBeDefined();
  });
});
