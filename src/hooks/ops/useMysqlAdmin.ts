...
// backend. Pairs 1:1 with the 101 `mysql_admin_*` commands registered by
// `sorng-commands-ops-databases` (see its `commands.json`).
//
...
export const mysqlAdminApi = {
  ...
  // Users & Grants (12)
  listUsers: (id: string) =>
    invoke<MysqlUser[]>("mysql_admin_list_users", { id }),
