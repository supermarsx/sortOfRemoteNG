...
export const hetznerApi = {
  ...
  connect: (connectionId: string, config: HetznerConnectionConfig) =>
    invoke<HetznerConnectionSummary>("hetzner_connect", {
      connectionId,
      config,
    }),
  ...
  ping: (connectionId: string) =>
    invoke<void>("hetzner_ping", { connectionId }),
  ...
  rebuildServer: (connectionId: string, id: number, image: string) =>
    invoke<HetznerAction>("hetzner_rebuild_server", {
      connectionId,
      id,
      image,
    }),
  ...
  deleteSubnet: (connectionId: string, id: number, ipRange: string) =>
    invoke<HetznerAction>("hetzner_delete_subnet", {
      connectionId,
      id,
      ipRange,
    }),
  ...
  createFirewall: (connectionId: string, request: CreateFirewallRequest) =>
    invoke<HetznerFirewall>("hetzner_create_firewall", {
      connectionId,
      request,
    }),
  updateFirewall: (
  ...
  removeLbTarget: (connectionId: string, id: number, target: HetznerLbTarget) =>
