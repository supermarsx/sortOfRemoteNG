...
export function mergeRdpSettings(
  ...
  return {
    ...
    security: {
      ...
      credsspOracleRemediation: global.credsspOracleRemediation ?? base.security?.credsspOracleRemediation,
      allowHybridEx: global.allowHybridEx ?? base.security?.allowHybridEx,
      nlaFallbackToTls: global.nlaFallbackToTls ?? base.security?.nlaFallbackToTls,
      tlsMinVersion: global.tlsMinVersion ?? base.security?.tlsMinVersion,
      ntlmEnabled: global.ntlmEnabled ?? base.security?.ntlmEnabled,
      kerberosEnabled: global.kerberosEnabled ?? base.security?.kerberosEnabled,
      pku2uEnabled: global.pku2uEnabled ?? base.security?.pku2uEnabled,
      restrictedAdmin: global.restrictedAdmin ?? base.security?.restrictedAdmin,
      remoteCredentialGuard: global.remoteCredentialGuard ?? base.security?.remoteCredentialGuard,
      enforceServerPublicKeyValidation: global.enforceServerPublicKeyValidation ?? base.security?.enforceServerPublicKeyValidation,
      credsspVersion: global.credsspVersion ?? base.security?.credsspVersion,
