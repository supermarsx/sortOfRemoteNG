...
export const CreateScriptForm: React.FC<CreateScriptFormProps> = ({
  ...
  return (
    <div className="p-6">
      <h3 className="text-lg font-semibold text-[var(--color-text)]">Create Script</h3>
      ...
      <div className="mt-6 space-y-4">
        ...
        <FormField label="Name">
          <input
            ...
            className="w-full rounded-lg border border-theme-border bg-surface px-3 py-2 text-sm text-[var(--color-text)] placeholder-text-muted focus:border-primary focus:outline-none"
          />
        </FormField>
        ...
        {triggerType === "login" && (
          <FormField label="Delay after login (ms)">
            <input
              ...
              className="w-40 rounded-lg border border-theme-border bg-surface px-3 py-2 text-sm text-[var(--color-text)]"
            />
          </FormField>
        )}
        ...
        {triggerType === "cron" && (
          <FormField label="Cron expression">
            <input
              ...
              placeholder="0 * * * *"
              className="w-60 rounded-lg border border-theme-border bg-surface px-3 py-2 text-sm text-[var(--color-text)] font-mono"
            />
          </FormField>
        )}
        {triggerType === "outputMatch" && (
          <FormField label="Output regex pattern">
            <input
              ...
              className="w-full rounded-lg border border-theme-border bg-surface px-3 py-2 text-sm text-[var(--color-text)] font-mono"
            />
          </FormField>
        )}
        {triggerType === "idle" && (
        ...
        <div className="grid grid-cols-3 gap-4">
          <FormField label="Category">
            <input
              ...
              className="w-full rounded-lg border border-theme-border bg-surface px-3 py-2 text-sm text-[var(--color-text)]"
            />
          </FormField>
      ...
      <div className="mt-6 flex justify-end gap-3">
        ...
        <button
          ...
          className="rounded-lg bg-primary px-5 py-2 text-sm font-medium text-[var(--color-text)] hover:bg-primary/90 disabled:opacity-50"
        >
