        ...
        <div className="px-4 py-3 space-y-3 border-t border-[var(--color-border)]">
          ...
          <div className="bg-[var(--color-surface)]/50 rounded-lg p-3 space-y-2">
            ...
            <input
              ...
              placeholder="Answer"
              className="w-full px-2 py-1.5 bg-[var(--color-input)] border border-[var(--color-border)] rounded text-xs text-[var(--color-text)] font-mono placeholder-[var(--color-textMuted)]"
            />
