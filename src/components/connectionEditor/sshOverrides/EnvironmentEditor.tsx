    ...
    <div className="space-y-2">
      {Object.entries(value).map(([key, val]) => (
        <div key={key} className="flex items-center gap-2">
          <code className="px-2 py-1 text-xs bg-[var(--color-border)] rounded text-success">
            {key}
          </code>
      ...
      <div className="flex items-center gap-2">
        ...
        <button
          ...
          className="p-1 text-success hover:text-success disabled:text-[var(--color-textMuted)]"
        >
