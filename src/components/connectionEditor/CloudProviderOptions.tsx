    ...
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        {provider === 'gcp' && (
          <>
            <div>
              <label className="block text-sm font-medium text-[var(--color-textSecondary)] mb-2">Project ID</label>
              <input
                type="text"
            ...
            <div>
              <label className="block text-sm font-medium text-[var(--color-textSecondary)] mb-2">Zone</label>
              <input
                type="text"
            ...
            <div>
              <label className="block text-sm font-medium text-[var(--color-textSecondary)] mb-2">Service Account Key (JSON)</label>
              <textarea
        ...
        {provider === 'azure' && (
          <>
            <div>
              <label className="block text-sm font-medium text-[var(--color-textSecondary)] mb-2">Subscription ID</label>
              <input
                type="text"
            ...
            <div>
              <label className="block text-sm font-medium text-[var(--color-textSecondary)] mb-2">Resource Group</label>
              <input
                type="text"
            ...
            <div>
              <label className="block text-sm font-medium text-[var(--color-textSecondary)] mb-2">Client ID</label>
              <input
                type="text"
            ...
            <div>
              <label className="block text-sm font-medium text-[var(--color-textSecondary)] mb-2">Client Secret</label>
              <PasswordInput
            ...
            <div>
              <label className="block text-sm font-medium text-[var(--color-textSecondary)] mb-2">Tenant ID</label>
              <input
                type="text"
        ...
        {(provider === 'ibm-csp' || provider === 'digital-ocean') && (
          <>
            <div>
              <label className="block text-sm font-medium text-[var(--color-textSecondary)] mb-2">API Key</label>
              <PasswordInput
            ...
            <div>
              <label className="block text-sm font-medium text-[var(--color-textSecondary)] mb-2">Region</label>
              <input
                type="text"
        ...
        {provider === 'heroku' && (
          <>
            ...
            <div>
              <label className="block text-sm font-medium text-[var(--color-textSecondary)] mb-2">App Name</label>
              <input
                type="text"
            ...
            <div>
              <label className="block text-sm font-medium text-[var(--color-textSecondary)] mb-2">Dyno Name (Optional)</label>
              <input
                type="text"
        ...
        {(provider === 'scaleway' || provider === 'linode' || provider === 'ovhcloud') && (
          <>
            ...
            {provider === 'scaleway' && (
              <div>
                <label className="block text-sm font-medium text-[var(--color-textSecondary)] mb-2">Organization ID</label>
                <input
                  type="text"
            ...
            {(provider === 'scaleway' || provider === 'ovhcloud') && (
              <div>
                <label className="block text-sm font-medium text-[var(--color-textSecondary)] mb-2">Project Name</label>
                <input
                  type="text"
            ...
            {provider === 'ovhcloud' && (
              <div>
                <label className="block text-sm font-medium text-[var(--color-textSecondary)] mb-2">Service ID</label>
                <input
                  type="text"
        ...
        <div>
          <label className="block text-sm font-medium text-[var(--color-textSecondary)] mb-2">Instance ID/Name</label>
          <input
            type="text"
