      ...
      {isExpanded && (
        <div className="p-4 space-y-4 bg-[var(--color-surface)]/50">
              ...
              <>
                ...
                >
                  <NumberInput value={getValue("font").size} onChange={(v: number) => updateOverride("font", {
                        ...getValue("font"),
                        size: v,
                      })} className="w-24 px-3 py-1.5  bg-[var(--color-input)] border border-[var(--color-border)] rounded text-[var(--color-text)]" min={8} max={32} />
                </OverrideToggle>
              </>
            )}
          </div>
          ...
          <div className="space-y-3">
            ...
            >
              <NumberInput value={getValue("scrollbackLines")} onChange={(v: number) => updateOverride("scrollbackLines", v)} className="w-28 px-3 py-1.5  bg-[var(--color-input)] border border-[var(--color-border)] rounded text-[var(--color-text)]" min={100} max={100000} step={1000} />
            </OverrideToggle>
          </div>
