...
export const RDP_DEFAULTS_SEARCH_ENTRIES: SettingSearchEntry[] = [
  ...
  // ─── Render Backend Defaults ────────────────────────────────────
  {
    ...
    description:
      "Controls CPU precomposition and delivery of decoded pixels to the Webview renderer.",
    ...
    values: [
      ...
      "softbuffer",
      "Softbuffer — CPU precomposition → Webview",
      "wgpu",
      "Wgpu — CPU compatibility fallback",
      "auto",
      "Auto — direct stream → Webview",
    ],
    section: "rdpDefaults",
    sectionLabel: "RDP Defaults",
  },
  ...
  },
  {
    ...
    values: [
      "vsync",
      "VSync — synced to display refresh",
      "low-latency",
      "Low-Latency — present when ready",
      "adaptive",
      "Adaptive — follow activity and capacity",
    ],
    section: "rdpDefaults",
    sectionLabel: "RDP Defaults",
  },
  ...
  // ─── Performance / Frame Delivery Defaults ──────────────────────
  {
    ...
    description:
      "Visual experience settings for your network speed. Preserves your optional frame rate limit.",
  ...
  },
  {
    ...
    label: "Maximum FPS",
    description:
      "Optional maximum FPS when the frame rate limit is enabled. Default delivery is uncapped and adapts to activity and capacity.",
  ...
  },
  {
    ...
    description:
      "Combines pending changed regions without a timed wait. Legacy batch intervals are ignored.",
    tags: ["frame", "batching", "batch", "dirty region", "ipc", "latency"],
    section: "rdpDefaults",
    sectionLabel: "RDP Defaults",
  },
  {
    key: "frameRateLimitEnabled",
    label: "Limit frame rate",
    description:
      "Enable an optional maximum FPS. Off uses uncapped adaptive delivery; idle sessions do not redraw.",
    tags: ["fps", "limit", "uncapped", "adaptive", "frame", "performance"],
    synonyms: ["unlimited", "frame rate cap"],
    section: "rdpDefaults",
    sectionLabel: "RDP Defaults",
  },
  {
  ...
  },
  {
    ...
    label: "H.264 Decoder",
    description:
      "Backend H.264 decoder. Media Foundation uses GPU hardware; OpenH264 is the packaged software fallback.",
    ...
    values: [
      ...
      "openh264",
      "OpenH264 (software, required native library)",
    ],
    section: "rdpDefaults",
    sectionLabel: "RDP Defaults",
  },
