  ...
  return (
    <div className="space-y-4">
      <SectionHeader
        ...
        title={t(
          "settings.recording.sections.sshTitle",
      ...
      <Card>
        <Toggle
          ...
          icon={<Power size={16} />}
          label={t(
            "settings.recording.ssh.enableLabel",
            "Enable SSH recording",
          )}
          description={t(
            "settings.recording.ssh.enableDescription",
            "Allow SSH terminal sessions to be recorded",
          )}
          checked={enabled}
          onChange={(v) => mgr.updateSsh({ enabled: v })}
          infoTooltip={t(
            "settings.recording.ssh.enableTooltip",
        ...
        >
          <Toggle
            ...
            icon={<Circle size={16} />}
            label={t(
              "settings.recording.ssh.autoRecordLabel",
              "Auto-record SSH sessions",
            )}
            description={t(
              "settings.recording.ssh.autoRecordDescription",
            ...
            infoTooltip={t(
              "settings.recording.ssh.autoRecordTooltip",
          ...
          <Toggle
            ...
            label={t(
              "settings.recording.ssh.recordInputLabel",
              "Record input (keystrokes)",
            )}
            description={t(
              "settings.recording.ssh.recordInputDescription",
            ...
            infoTooltip={t(
              "settings.recording.ssh.recordInputTooltip",
          ...
          <SettingsNumberRow
            ...
            icon={<Clock size={16} />}
            label={t(
              "settings.recording.ssh.maxDurationLabel",
              "Max recording duration",
            )}
            value={mgr.recording.maxRecordingDurationMinutes}
            min={0}
            unit="min"
            onChange={(v) => mgr.updateSsh({ maxRecordingDurationMinutes: v })}
            infoTooltip={t(
              "settings.recording.common.maxDurationTooltip",
          ...
          <SettingsNumberRow
            ...
            label={t(
              "settings.recording.ssh.maxStoredLabel",
              "Max stored recordings",
            )}
            value={mgr.recording.maxStoredRecordings}
            min={1}
            onChange={(v) => mgr.updateSsh({ maxStoredRecordings: v })}
            infoTooltip={t(
              "settings.recording.common.maxStoredTooltip",
          ...
          <SettingsSelectRow
            ...
            label={t(
              "settings.recording.defaultExportFormatLabel",
            ...
            options={[
              { value: "asciicast", label: "Asciicast (asciinema)" },
              {
                value: "script",
                label: t(
                  "settings.recording.formats.scriptText",
                  "Script (text)",
                ),
              },
              { value: "json", label: "JSON" },
              {
                value: "gif",
                label: t(
                  "settings.recording.formats.gifAnimated",
                  "GIF (animated)",
                ),
              },
            ]}
            onChange={(v) =>
              mgr.updateSsh({
                defaultExportFormat:
                  v as RecordingConfig["defaultExportFormat"],
              })
            }
            infoTooltip={t(
              "settings.recording.ssh.exportFormatTooltip",
        ...
        <StorageFooter
          items={[
            <>
              ...
              {mgr.sshCount === 1
                ? t(
                    "settings.recording.storage.sshRecordingOne",
                    "SSH recording",
                  )
                : t(
                    "settings.recording.storage.sshRecordingOther",
                    "SSH recordings",
                  )}{" "}
              {t("settings.recording.storage.stored", "stored")}
            </>,
          ]}
        />
      </Card>
  ...
  return (
    <div className="space-y-4">
      <SectionHeader
        ...
        title={t(
          "settings.recording.sections.rdpTitle",
      ...
      <Card>
        <Toggle
          ...
          icon={<Power size={16} />}
          label={t(
            "settings.recording.rdp.enableLabel",
            "Enable RDP recording",
          )}
          description={t(
            "settings.recording.rdp.enableDescription",
            "Allow RDP sessions to be screen-recorded",
          )}
          checked={enabled}
          onChange={(v) => mgr.updateRdp({ enabled: v })}
          infoTooltip={t(
            "settings.recording.rdp.enableTooltip",
        ...
        >
          <Toggle
            ...
            icon={<Circle size={16} />}
            label={t(
              "settings.recording.rdp.autoRecordLabel",
              "Auto-record RDP sessions",
            )}
            description={t(
              "settings.recording.rdp.autoRecordDescription",
            ...
            infoTooltip={t(
              "settings.recording.rdp.autoRecordTooltip",
          ...
          <Toggle
            ...
            icon={<Save size={16} />}
            label={t(
              "settings.recording.rdp.autoSaveLabel",
              "Auto-save to library",
            )}
            description={t(
              "settings.recording.rdp.autoSaveDescription",
              "Save RDP recordings to the Recording Manager instead of prompting a file dialog",
            )}
            checked={mgr.rdpRec.autoSaveToLibrary}
            onChange={(v) => mgr.updateRdp({ autoSaveToLibrary: v })}
            infoTooltip={t(
              "settings.recording.rdp.autoSaveTooltip",
          ...
          <SettingsSelectRow
            ...
            infoTooltip={t(
              "settings.recording.rdp.videoFormatTooltip",
          ...
          <SettingsSliderRow
            ...
            description={t(
              "settings.recording.rdp.fpsDescription",
            ...
            infoTooltip={t(
              "settings.recording.rdp.fpsTooltip",
          ...
          <SettingsSliderRow
            ...
            description={t(
              "settings.recording.rdp.bitrateDescription",
            ...
            infoTooltip={t(
              "settings.recording.rdp.bitrateTooltip",
          ...
          <SettingsNumberRow
            ...
            icon={<Clock size={16} />}
            label={t(
              "settings.recording.rdp.maxDurationLabel",
          ...
          <SettingsNumberRow
            ...
            icon={<HardDrive size={16} />}
            label={t(
              "settings.recording.rdp.maxStoredLabel",
              "Max stored RDP recordings",
            )}
            value={mgr.rdpRec.maxStoredRdpRecordings}
            min={1}
            onChange={(v) => mgr.updateRdp({ maxStoredRdpRecordings: v })}
            infoTooltip={t(
              "settings.recording.common.maxStoredTooltip",
              "Keeps the recording library bounded. Once the cap is hit the oldest recordings are rotated out.",
            )}
        ...
        <StorageFooter
          items={[
            <>
              ...
              {mgr.rdpCount === 1
                ? t(
                    "settings.recording.storage.rdpRecordingOne",
                    "RDP recording",
                  )
                : t(
                    "settings.recording.storage.rdpRecordingOther",
                    "RDP recordings",
                  )}{" "}
              {t("settings.recording.storage.stored", "stored")}
            </>,
  ...
  return (
    <div className="space-y-4">
      <SectionHeader
        ...
        title={t(
          "settings.recording.sections.webTitle",
      ...
      <Card>
        <Toggle
          ...
          icon={<Power size={16} />}
          label={t(
            "settings.recording.web.enableLabel",
            "Enable web recording",
          )}
          description={t(
            "settings.recording.web.enableDescription",
            "Allow web sessions to be recorded (HAR and video)",
          )}
          checked={enabled}
          onChange={(v) => mgr.updateWeb({ enabled: v })}
          infoTooltip={t(
            "settings.recording.web.enableTooltip",
        ...
        >
          <Toggle
            ...
            icon={<Circle size={16} />}
            label={t(
              "settings.recording.web.autoRecordLabel",
              "Auto-record web sessions",
            )}
            description={t(
              "settings.recording.web.autoRecordDescription",
            ...
            infoTooltip={t(
              "settings.recording.web.autoRecordTooltip",
          ...
          <Toggle
            ...
            icon={<Eye size={16} />}
            label={t(
              "settings.recording.web.recordHeadersLabel",
              "Record HTTP headers",
            )}
            description={t(
              "settings.recording.web.recordHeadersDescription",
            ...
            infoTooltip={t(
              "settings.recording.web.recordHeadersTooltip",
          ...
          <SettingsNumberRow
            ...
            icon={<Clock size={16} />}
            label={t(
              "settings.recording.web.maxDurationLabel",
          ...
          <SettingsNumberRow
            ...
            icon={<HardDrive size={16} />}
            label={t(
              "settings.recording.web.maxStoredLabel",
              "Max stored web recordings",
            )}
            value={mgr.webRec.maxStoredWebRecordings}
            min={1}
            onChange={(v) => mgr.updateWeb({ maxStoredWebRecordings: v })}
            infoTooltip={t(
              "settings.recording.common.maxStoredTooltip",
              "Keeps the recording library bounded. Once the cap is hit the oldest recordings are rotated out.",
            )}
          ...
          <SettingsSelectRow
            ...
            infoTooltip={t(
              "settings.recording.web.exportFormatTooltip",
        ...
        <StorageFooter
          items={[
            <>
              ...
              {mgr.webCount === 1
                ? t(
                    "settings.recording.storage.harRecordingOne",
                    "HAR recording",
                  )
                : t(
                    "settings.recording.storage.harRecordingOther",
                    "HAR recordings",
                  )}{" "}
              {t("settings.recording.storage.stored", "stored")}
            </>,
            <>
              ...
              {mgr.webVideoCount === 1
                ? t(
                    "settings.recording.storage.videoRecordingOne",
                    "video recording",
                  )
                : t(
                    "settings.recording.storage.videoRecordingOther",
                    "video recordings",
                  )}{" "}
              {t("settings.recording.storage.stored", "stored")}
            </>,
    ...
    <div className="space-y-6">
      <SectionHeading
        ...
        description={t(
          ...
          "Configure SSH terminal, RDP screen, and web session recording, export formats, and storage limits.",
        )}
      />

      <Toggle
        settingKey="confirmDeleteRecording"
        label={t(
          "settings.recording.confirmDeleteLabel",
          "Confirm recording deletion",
        )}
        description={t(
          "settings.recording.confirmDeleteDescription",
          "Ask before deleting saved recordings or clearing a recording library.",
        )}
        checked={settings.confirmDeleteRecording !== false}
        onChange={(checked) =>
          updateSettings({ confirmDeleteRecording: checked })
        }
      />
