      ...
      <div className="space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3 ml-1">
          ...
          <label className="flex items-center space-x-3 cursor-pointer group">
            ...
            <Shield className="w-4 h-4 text-accent group-hover:text-accent" />
            <span className="text-[var(--color-textSecondary)] group-hover:text-[var(--color-text)]">
              Proxy/VPN Menu
            </span>
          </label>
          ...
          <label className="flex items-center space-x-3 cursor-pointer group">
            ...
            <Keyboard className="w-4 h-4 text-accent group-hover:text-accent" />
            <span className="text-[var(--color-textSecondary)] group-hover:text-[var(--color-text)]">
              Shortcut Manager
            </span>
          </label>
          ...
          <label className="flex items-center space-x-3 cursor-pointer group">
            ...
            <FileCode className="w-4 h-4 text-accent group-hover:text-accent" />
            <span className="text-[var(--color-textSecondary)] group-hover:text-[var(--color-text)]">
              Script Manager
            </span>
          </label>
          ...
          <label className="flex items-center space-x-3 cursor-pointer group">
            ...
            <Cpu className="w-4 h-4 text-accent group-hover:text-accent" />
            <span className="text-[var(--color-textSecondary)] group-hover:text-[var(--color-text)]">
              RDP Sessions
            </span>
          </label>
