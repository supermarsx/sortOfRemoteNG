      ...
      <div className="space-y-4">
        ...
        <div className="sor-settings-card space-y-4">
          ...
          <label className="flex items-center space-x-3 cursor-pointer group">
            ...
            />
            <Network className="w-4 h-4 text-[var(--color-textMuted)] group-hover:text-primary" />
          ...
          <label className="flex items-center space-x-3 cursor-pointer group">
            ...
            />
            <Fingerprint className="w-4 h-4 text-[var(--color-textMuted)] group-hover:text-primary" />
            <span className="text-[var(--color-textSecondary)] group-hover:text-[var(--color-text)] flex items-center gap-1">
          ...
          <label className="flex items-center space-x-3 cursor-pointer group">
            ...
            />
            <ArrowLeftRight className="w-4 h-4 text-[var(--color-textMuted)] group-hover:text-primary" />
            <span className="text-[var(--color-textSecondary)] group-hover:text-[var(--color-text)] flex items-center gap-1">
      ...
      <div className="space-y-4">
        ...
        <div className="sor-settings-card space-y-4">
          <label className="flex items-center space-x-3 cursor-pointer group">
            ...
            />
            <Play className="w-4 h-4 text-[var(--color-textMuted)] group-hover:text-primary" />
            <span className="text-[var(--color-textSecondary)] group-hover:text-[var(--color-text)] flex items-center gap-1">
              Auto-Run on Open
          ...
          <label className="flex items-center space-x-3 cursor-pointer group">
            ...
            />
            <Eye className="w-4 h-4 text-[var(--color-textMuted)] group-hover:text-primary" />
            <span className="text-[var(--color-textSecondary)] group-hover:text-[var(--color-text)] flex items-center gap-1">
          ...
          <label className="flex items-center space-x-3 cursor-pointer group">
            ...
            />
            <AlertTriangle className="w-4 h-4 text-[var(--color-textMuted)] group-hover:text-primary" />
            <span className="text-[var(--color-textSecondary)] group-hover:text-[var(--color-text)] flex items-center gap-1">
