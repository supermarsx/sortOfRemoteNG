...
export const SETTINGS_SEARCH_INDEX: SettingSearchEntry[] = [
  ...
  { key: 'timeFormat', label: 'Time Format', description: '12-hour or 24-hour clock for timestamps', tags: ['time', '12h', '24h', 'clock', 'format', 'locale'], section: 'language', sectionLabel: 'Language' },
  { key: 'dateFormat', label: 'Date Format', description: 'Date display style for timestamps', tags: ['date', 'format', 'short', 'long', 'locale'], section: 'language', sectionLabel: 'Language' },
  { key: 'timeZone', label: 'Time Zone', description: 'Display timestamps in a specific IANA time zone', tags: ['timezone', 'tz', 'utc', 'iana', 'zone', 'clock'], section: 'language', sectionLabel: 'Language' },
  { key: 'calendarSystem', label: 'Calendar System', description: 'Calendar used to render dates (Gregorian, Islamic, Hebrew, …)', tags: ['calendar', 'gregorian', 'islamic', 'hebrew', 'buddhist', 'japanese', 'persian'], section: 'language', sectionLabel: 'Language' },
  { key: 'numberingSystem', label: 'Numbering System', description: 'Digit set used in numbers and dates', tags: ['numbering', 'digits', 'arabic', 'latin', 'devanagari', 'numerals'], section: 'language', sectionLabel: 'Language' },
  ...
  { key: 'exportSecurity', label: 'Export Security', description: 'Default export encryption, password strength, metadata, and content inclusion settings', tags: ['export', 'encryption', 'password', 'strength', 'entropy', 'pbkdf2', 'iterations', 'metadata', 'settings', 'folders', 'protocols'], section: 'security', sectionLabel: 'Security' },
  { key: 'exportSecurity.keyDerivationIterations', label: 'Export PBKDF2 Iterations', description: 'PBKDF2 iterations used for password-encrypted export files', tags: ['export', 'pbkdf2', 'iterations', 'bruteforce', 'password'], section: 'security', sectionLabel: 'Security' },
  { key: 'exportSecurity.showPasswordStrength', label: 'Export Password Strength Meter', description: 'Show entropy and password quality feedback in the export tab', tags: ['export', 'password', 'entropy', 'strength', 'common passwords'], section: 'security', sectionLabel: 'Security' },
  ...
  // ─── MCP Server ─────────────────────────────────────────────────
  { key: 'mcpServer.enabled', label: 'Enable MCP Server', description: 'Allow AI assistants to connect through Model Context Protocol', tags: ['mcp', 'model context protocol', 'ai', 'assistant', 'server', 'automation'], section: 'mcpServer', sectionLabel: 'MCP Server' },
  { key: 'mcpServer.auto_start', label: 'MCP Auto-start', description: 'Start the MCP server automatically when the app launches', tags: ['mcp', 'startup', 'auto start', 'launch'], section: 'mcpServer', sectionLabel: 'MCP Server' },
  { key: 'mcpServer.host', label: 'MCP Host', description: 'Host address the MCP server binds to', tags: ['mcp', 'host', 'bind', 'localhost', 'network'], section: 'mcpServer', sectionLabel: 'MCP Server' },
  { key: 'mcpServer.port', label: 'MCP Port', description: 'TCP port used by the MCP server', tags: ['mcp', 'port', 'network', 'http'], section: 'mcpServer', sectionLabel: 'MCP Server' },
  { key: 'mcpServer.require_auth', label: 'MCP Authentication', description: 'Require API key authentication for MCP requests', tags: ['mcp', 'auth', 'api key', 'security', 'bearer'], section: 'mcpServer', sectionLabel: 'MCP Server' },
  { key: 'mcpServer.allow_remote', label: 'MCP Remote Access', description: 'Allow non-localhost clients to connect to the MCP server', tags: ['mcp', 'remote', 'network', 'security'], section: 'mcpServer', sectionLabel: 'MCP Server' },
  { key: 'mcpServer.expose_sensitive_data', label: 'MCP Sensitive Data', description: 'Control whether MCP resources can include passwords and secrets', tags: ['mcp', 'secrets', 'passwords', 'privacy', 'security'], section: 'mcpServer', sectionLabel: 'MCP Server' },
