        ...
        <div className="flex-1 overflow-y-auto p-6 space-y-6">
          ...
          <div className="flex flex-wrap gap-3">
            ...
            {!formData.isGroup && (
              ...
              >
                ...
                <Star
                  size={16}
                  className={formData.favorite ? "fill-yellow-400" : ""}
                />
          ...
          <div>
            <label className="block text-sm font-medium text-[var(--color-textSecondary)] mb-2">
              {formData.isGroup ? "Folder Name" : "Connection Name"}{" "}
            ...
            <input
              ...
              placeholder={
                formData.isGroup ? "My Servers" : "Production Server"
              }
              autoFocus
            />
          </div>
