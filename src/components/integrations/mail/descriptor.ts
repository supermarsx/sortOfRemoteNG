...
//
// The single top-level hub entry for the mail stack — transport, delivery,
// filtering, authentication, and Roundcube administration live as sub-tabs
// INSIDE this one panel, not as separate descriptors. Kept in a
