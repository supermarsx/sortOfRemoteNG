        ...
        <div className="bg-[var(--color-surface)] border-b border-[var(--color-border)] p-4">
          <div className="grid grid-cols-2 md:grid-cols-3 gap-4 text-sm">
            <div>
              ...
              <Select value={mgr.settings.quality} onChange={(v: string) => mgr.setSettings({...mgr.settings, quality: v})} options={[{ value: "low", label: "Low" }, { value: "balanced", label: "Balanced" }, { value: "high", label: "High" }, { value: "best", label: "Best" }]} className="sor-form-input-xs" />
            </div>
