...
function ensureKeyframes(): void {
  ...
  style.textContent =
    "@keyframes sorng-phyllotaxis-spin { to { transform: rotate(360deg); } }";
...
const PhyllotaxisVariant: React.FC<VariantRenderProps<"phyllotaxis">> = ({
  ...
  const faceStyle: CSSProperties = {
    ...
    animation: reducedMotion
      ? undefined
      : "sorng-phyllotaxis-spin 40s linear infinite",
...
export const descriptor: VariantDescriptor<"phyllotaxis"> = {
  ...
  description:
    "Sunflower face — golden-angle 2D bloom with a wave rolling outward.",
  ...
  presets: [
    { id: "classic", label: "Classic", config: {} },
    {
      id: "tight",
      label: "Tight bloom",
      config: { dots: 1400, spacing: 0.6, trail: 0.18 },
    },
    {
      id: "wide",
      label: "Wide bloom",
      config: { dots: 500, spacing: 1.4, trail: 0.5 },
    },
  ],
  paramSchema: {
    fields: [
