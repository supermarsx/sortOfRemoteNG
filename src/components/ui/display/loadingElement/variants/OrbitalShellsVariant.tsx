...
const OrbitalShellsVariant: React.FC<VariantRenderProps<"orbitalShells">> = ({
  ...
  const ringRefs = useRef<
    [HTMLDivElement | null, HTMLDivElement | null, HTMLDivElement | null]
  >([null, null, null]);
  ...
  const r2Style: CSSProperties = {
    ...
    animation: reducedMotion
      ? undefined
      : "sorng-os-r2 11s linear infinite reverse",
    animationPlayState: playState,
  };
  ...
  const nucleusStyle: CSSProperties = {
    ...
    animation: reducedMotion
      ? undefined
      : "sorng-os-pulse 2.4s ease-in-out infinite",
    animationPlayState: playState,
  };
...
export const descriptor: VariantDescriptor<"orbitalShells"> = {
  ...
  description:
    "Atomic-style nucleus with three rings on different axes — dots travel each shell.",
