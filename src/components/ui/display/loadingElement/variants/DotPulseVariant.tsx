...
const DotPulseVariant: FC<VariantRenderProps<"dotPulse">> = ({
  ...
  const beforeMask =
    "radial-gradient(circle at 50% 50%, black 35%, transparent 72%)";
...
export const descriptor: VariantDescriptor<"dotPulse"> = {
  ...
  presets: [
    { id: "default", label: "Default", config: DEFAULT_DOT_PULSE },
    {
      id: "fast",
      label: "Fast",
      config: { coreSpeed: 1.0, ringSpeed: 1.4, rings: 3 },
    },
    {
      id: "serene",
      label: "Serene",
      config: { coreSpeed: 2.4, ringSpeed: 4.0, rings: 2 },
    },
    {
      id: "broadcast",
      label: "Broadcast",
      config: { coreSpeed: 1.6, ringSpeed: 2.4, rings: 4 },
    },
  ],
  paramSchema: {
    fields: [
      {
        ...
        max: 3,
        step: 0.1,
        help: "Pulse animation duration in seconds.",
      },
      {
        key: "ringSpeed",
        label: "Shockwave",
        ...
        max: 6,
        step: 0.1,
        help: "Shockwave period in seconds.",
      },
      {
        key: "rings",
