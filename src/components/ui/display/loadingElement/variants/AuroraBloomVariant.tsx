...
const AuroraBloomVariant: React.FC<VariantRenderProps<"auroraBloom">> = ({
  ...
  const auraStyle: CSSProperties = {
    ...
    animation: reducedMotion
      ? undefined
      : `sorng-aurora-aura ${auraSeconds}s ease-in-out infinite`,
  ...
  const sphereStyle: CSSProperties = {
    ...
    animation: reducedMotion
      ? undefined
      : "sorng-aurora-breathe 6s ease-in-out infinite",
    animationPlayState: playState,
  };
...
export const descriptor: VariantDescriptor<"auroraBloom"> = {
  ...
  label: "Aurora bloom",
  description:
    "Glassy sphere with four soft color blobs drifting on irregular periods.",
  ...
  presets: [
    { id: "classic", label: "Classic", config: {} },
    {
      ...
      config: {
        ...
        tertiaryColor: "#62e6c4",
        quaternaryColor: "#b48cff",
      },
    },
    {
      id: "warm",
