    ...
    >
      ...
      <span
        ...
        style={{
          ...
          animation:
            animMode ?? `ct-corebeat ${coreSpeed}s steps(2, end) infinite`,
      ...
      {Array.from({ length: ringCount }, (_, i) => {
        const period =
          (RING_PERIODS[i] ?? RING_PERIODS[0]) / Math.max(0.1, trailSpeed);
        ...
        const slot: CSSProperties = (() => {
          ...
          if (i === 2)
            return { top: "50%", left: 0, marginTop: -moteHalf, marginLeft: 0 };
          if (i === 3)
            return {
              top: "50%",
              right: 0,
...
export const descriptor: VariantDescriptor<"cometTrails"> = {
  ...
  presets: [
    { id: "default", label: "Default", config: DEFAULT_COMET_TRAILS },
    {
      id: "mono",
      label: "Mono",
      config: { ...DEFAULT_COMET_TRAILS, splitTone: false },
    },
    {
      id: "synthwave",
      label: "Synthwave",
  ...
  paramSchema: {
    fields: [
      ...
      },
      {
        ...
        label: "Split-tone",
        kind: "boolean",
        help: "Use the secondary color on the second ring.",
      },
