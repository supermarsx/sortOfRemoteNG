    ...
    <div className="sor-status-item p-3">
      <div className="flex items-center justify-between mb-2">
        <div className="flex items-center gap-2">
          ...
          <span className="text-sm font-medium text-[var(--color-textSecondary)]">{PROVIDER_NAMES[provider]}</span>
...
export const CloudSyncStatusPopup: React.FC<CloudSyncStatusPopupProps> = ({
  ...
  return (
    <div className="relative" ref={mgr.dropdownRef}>
      <button onClick={() => mgr.setIsOpen(!mgr.isOpen)} className="app-bar-button p-2" title={mgr.t("sync.title", "Cloud Sync Status")} data-testid="cloud-sync-status">
