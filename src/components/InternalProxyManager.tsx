...
export const InternalProxyManager: React.FC<InternalProxyManagerProps> = ({ isOpen, onClose }) => {
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center justify-between">
                ...
                {sessions.length > 0 && (
                  <button
                    ...
                    className="flex items-center space-x-1.5 px-3 py-1.5 bg-red-900/30 hover:bg-red-900/50 text-red-400 rounded-lg text-xs transition-colors"
                  >
                    <StopCircle size={12} />
                    <span>Stop All</span>
                  </button>
              ...
              {sessions.length === 0 ? (
                <div className="text-center py-16 text-gray-500">
                  ...
                  <p className="text-xs mt-1">Sessions are created when you open HTTP/HTTPS connections with authentication.</p>
                </div>
              ) : (
                      ...
                      <div className="flex items-start justify-between">
                        <div className="flex-1 min-w-0">
                          ...
                          <div className="flex items-center space-x-4 text-xs text-[var(--color-textSecondary)]">
                            ...
                            <span className="flex items-center space-x-1">
                              <ArrowUpDown size={10} />
                              <span>{s.request_count} req{s.request_count !== 1 ? 's' : ''}</span>
                            </span>
                            {s.error_count > 0 && (
