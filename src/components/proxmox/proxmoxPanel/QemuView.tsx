    ...
    <div className="p-6 overflow-y-auto flex-1">
      <div className="flex items-center justify-between mb-4">
        ...
        <button
          ...
          className="px-3 py-1.5 rounded-lg bg-primary hover:bg-primary/90 text-[var(--color-text)] text-xs font-medium transition-colors"
        >
        ...
        <div className="space-y-2">
          {mgr.filteredVms.map((vm) => (
            ...
            >
              ...
              >
                <div
                  className={`w-2 h-2 rounded-full ${statusColor(vm.status)}`}
                />
                      ...
                      <ActionBtn
                        ...
                        onClick={() =>
                          mgr.requestConfirm(
                            ...
                            t(
                              "proxmox.qemu.shutdownMsg",
                              `Gracefully shutdown VM ${vm.vmid}?`,
                            ),
                      ...
                      <ActionBtn
                        ...
                        onClick={() =>
                          mgr.requestConfirm(
                            ...
                            t(
                              "proxmox.qemu.stopMsg",
                              `Force stop VM ${vm.vmid}? This may cause data loss.`,
                            ),
                  ...
                  <ActionBtn
                    ...
                    onClick={() =>
                      mgr.requestConfirm(
                        ...
                        t(
                          "proxmox.qemu.deleteMsg",
                          `Permanently delete VM ${vm.vmid} (${vm.name})?`,
                        ),
                        async () => {
