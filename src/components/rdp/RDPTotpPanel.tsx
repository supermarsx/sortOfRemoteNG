...
const AddForm: React.FC<{ mgr: RDPTotpPanelMgr }> = ({ mgr }) => (
  <div className="p-3 border-b border-[var(--color-border)] space-y-2">
    <input
      ...
      className="w-full px-2 py-1 bg-[var(--color-input)] border border-[var(--color-border)] rounded text-xs text-[var(--color-text)] placeholder-[var(--color-textMuted)]"
    />
    <input
      type="text"
      value={mgr.newIssuer}
    ...
    <div className="relative">
      <input
        ...
        className="w-full px-2 py-1 pr-7 bg-[var(--color-input)] border border-[var(--color-border)] rounded text-xs text-[var(--color-text)] placeholder-[var(--color-textMuted)] font-mono"
      />
      <button
        type="button"
