    ...
    <div className="flex flex-col h-full">
      ...
      <div className="flex items-center gap-2 px-3 py-2 border-b border-[var(--color-border)] flex-shrink-0">
        ...
        <button
          ...
          className={`p-1 rounded transition-colors ${mgr.autoScroll ? "text-primary bg-primary/30" : "text-[var(--color-textMuted)] hover:text-[var(--color-textSecondary)]"}`}
      ...
      >
        {mgr.filteredLogs.length === 0 ? (
          <div className="flex items-center justify-center h-full text-[var(--color-textMuted)] text-xs">
            No log entries
          </div>
        ) : (
      ...
      {/* Status bar */}
      <div className="px-3 py-1 border-t border-[var(--color-border)] text-[10px] text-[var(--color-textMuted)] flex-shrink-0">
