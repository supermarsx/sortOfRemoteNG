...
const RDPErrorScreen: React.FC<RDPErrorScreenProps> = ({
  ...
  return (
    <div className="absolute inset-0 flex flex-col bg-[var(--color-background)] overflow-hidden" data-testid="rdp-error-screen">
