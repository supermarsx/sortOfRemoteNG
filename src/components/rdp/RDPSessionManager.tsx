...
const SessionInfoGrid: React.FC<{
  ...
  <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 text-xs">
    <div className="bg-[var(--color-background)]/50 rounded px-2.5 py-1.5">
      <span className="text-[var(--color-textMuted)] block">Resolution</span>
      <span className="text-[var(--color-textSecondary)] font-mono">
        {session.desktop_width}&times;{session.desktop_height}
      </span>
    </div>
    <div className="bg-[var(--color-background)]/50 rounded px-2.5 py-1.5">
      <span className="text-[var(--color-textMuted)] block">Session ID</span>
      <span
    ...
    {stats && (
      <>
        <div className="bg-[var(--color-background)]/50 rounded px-2.5 py-1.5">
          <span className="text-[var(--color-textMuted)] flex items-center gap-1">
        ...
        <div className="bg-[var(--color-background)]/50 rounded px-2.5 py-1.5">
          <span className="text-[var(--color-textMuted)] block">Received</span>
          <span className="text-[var(--color-textSecondary)] font-mono">
            {formatBytes(stats.bytes_received)}
          </span>
        </div>
        <div className="bg-[var(--color-background)]/50 rounded px-2.5 py-1.5">
          <span className="text-[var(--color-textMuted)] block">Sent</span>
          <span className="text-[var(--color-textSecondary)] font-mono">
