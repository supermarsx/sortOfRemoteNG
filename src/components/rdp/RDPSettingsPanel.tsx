    ...
    <div className="bg-[var(--color-surface)] border-b border-[var(--color-border)] p-4">
      <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4 text-sm">
        <div className="bg-[var(--color-background)] rounded p-2">
          <div className="text-[var(--color-textMuted)] text-xs mb-1">Resolution</div>
          <div className="text-[var(--color-text)] text-xs font-mono">{rdpSettings.display?.width ?? 1920}x{rdpSettings.display?.height ?? 1080}</div>
        </div>
        <div className="bg-[var(--color-background)] rounded p-2">
          <div className="text-[var(--color-textMuted)] text-xs mb-1">Color Depth</div>
          <div className="text-[var(--color-text)] text-xs font-mono">{colorDepth}-bit</div>
        </div>
        <div className="bg-[var(--color-background)] rounded p-2">
        ...
        <div className="bg-[var(--color-background)] rounded p-2">
          <div className="text-[var(--color-textMuted)] text-xs mb-1">Speed Preset</div>
          <div className="text-[var(--color-text)] text-xs font-mono capitalize">{perfLabel}</div>
        </div>
        <div className="bg-[var(--color-background)] rounded p-2">
        ...
        <div className="bg-[var(--color-background)] rounded p-2">
          <div className="text-[var(--color-textMuted)] text-xs mb-1">Security</div>
          <div className="text-[var(--color-text)] text-xs font-mono">
            {rdpSettings.security?.enableNla ? 'NLA' : ''}{rdpSettings.security?.enableTls ? '+TLS' : ''}
          </div>
        </div>
        <div className="bg-[var(--color-background)] rounded p-2">
          <div className="text-[var(--color-textMuted)] text-xs mb-1">Keyboard</div>
          <div className="text-[var(--color-text)] text-xs font-mono">
            0x{(rdpSettings.input?.keyboardLayout ?? 0x0409).toString(16).padStart(4, '0')}
          </div>
        </div>
        <div className="bg-[var(--color-background)] rounded p-2">
          <div className="text-[var(--color-textMuted)] text-xs mb-1">Mouse Mode</div>
          <div className="text-[var(--color-text)] text-xs font-mono capitalize">{rdpSettings.input?.mouseMode ?? 'absolute'}</div>
        </div>
        <div className="bg-[var(--color-background)] rounded p-2">
          <div className="text-[var(--color-textMuted)] text-xs mb-1">Perf Flags</div>
          <div className="text-[var(--color-text)] text-xs font-mono">
            {[
