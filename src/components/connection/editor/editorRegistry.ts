    ...
    fields: [
      {
        ...
        protocols: ["idrac", "ilo", "lenovo", "supermicro"],
        ...
        valuePaths: [
          "idracSettings.forceProtocol",
          "iloSettings.protocol",
          "lenovoSettings.protocol",
          "supermicroSettings.useSsl",
        ],
      },
      {
        id: "bmc-generation",
        label: "Controller generation",
        protocols: ["ilo", "lenovo"],
        protocolSubtabId: "connection",
        keywords: ["ilo generation", "xcc", "imm"],
        optionText: [
          "iLO 1",
          "iLO 2",
          "iLO 3",
        ...
        valuePaths: ["iloSettings.generation", "lenovoSettings.generation"],
      },
      {
        id: "bmc-platform",
        label: "Supermicro platform generation",
        protocols: ["supermicro"],
        protocolSubtabId: "connection",
        keywords: ["x13", "h13", "x12", "h12", "x11", "x10", "x9"],
        valuePaths: ["supermicroSettings.platform"],
      },
      {
        id: "bmc-ipmi-port",
        label: "IPMI port",
        protocols: ["ilo", "lenovo"],
        protocolSubtabId: "connection",
        keywords: ["ipmi", "udp", "623"],
        copy: ["623"],
        valuePaths: ["iloSettings.ipmiPort", "lenovoSettings.ipmiPort"],
      },
      {
        id: "bmc-auth-method",
        label: "BMC authentication method",
        protocols: ["ilo", "supermicro"],
        protocolSubtabId: "authentication",
        keywords: ["basic", "session", "token"],
        optionText: ["Session token", "HTTP Basic"],
        valuePaths: ["iloSettings.authMethod", "supermicroSettings.authMethod"],
      },
      {
        id: "bmc-certificate-verification",
        label: "Verify BMC server certificate",
        protocols: ["idrac", "ilo", "lenovo", "supermicro"],
        protocolSubtabId: "security",
        keywords: ["tls", "ssl", "certificate", "self-signed", "insecure"],
        valuePaths: [
          "idracSettings.insecure",
          "iloSettings.insecure",
          "lenovoSettings.insecure",
          "supermicroSettings.verifyCert",
        ],
      },
      {
        id: "bmc-timeout",
        label: "BMC connection timeout",
        protocols: ["idrac", "ilo", "lenovo", "supermicro"],
        protocolSubtabId: "advanced",
        keywords: ["timeout", "seconds"],
        copy: ["30"],
        valuePaths: [
          "idracSettings.timeoutSecs",
          "iloSettings.timeoutSecs",
          "lenovoSettings.timeoutSecs",
          "supermicroSettings.timeoutSecs",
        ],
      },
      {
        id: "voip-phone-vendor",
        label: "Phone vendor",
        protocols: ["voip-phone"],
        protocolSubtabId: "connection",
        keywords: ["voip", "phone", "vendor", "yealink", "sip", "t20p", "t21p"],
        optionText: ["Yealink"],
        valuePaths: ["voipPhoneSettings.vendor"],
      },
      {
        id: "voip-phone-auth-mode",
        label: "Web admin login mode",
        protocols: ["voip-phone"],
        protocolSubtabId: "authentication",
        keywords: ["auth", "login", "basic", "form", "servlet", "auto-detect"],
        optionText: ["Auto-detect", "HTTP Basic", "Login form"],
        valuePaths: ["voipPhoneSettings.authMode"],
      },
      {
        id: "voip-phone-tls",
        label: "Phone web admin TLS",
        protocols: ["voip-phone"],
        protocolSubtabId: "security",
        keywords: [
          "https",
        ...
        valuePaths: [
          "voipPhoneSettings.useSsl",
          "voipPhoneSettings.verifyCert",
        ],
      },
      {
        id: "voip-phone-action-uri",
        label: "Action URI remote control",
        protocols: ["voip-phone"],
        protocolSubtabId: "advanced",
        keywords: ["action uri", "remote control", "reboot", "timeout"],
        copy: ["Features > Remote Control", "15"],
        valuePaths: [
          "voipPhoneSettings.actionUriEnabled",
          "voipPhoneSettings.timeoutSecs",
        ],
      },
      {
        id: "telnet-plaintext",
      ...
      },
      {
        ...
        copy: [
          ...
          "/dev/ttyUSB0",
          "Device selection",
          "First USB serial device",
          "Preview",
        ],
        valuePaths: [
          "serialSettings.portName",
          "serialSettings.portSelection.mode",
        ],
      },
      {
        id: "serial-device-match",
        label: "Match a serial device by USB id or name",
        protocols: ["serial"],
        protocolSubtabId: "connection",
        keywords: ["vid", "pid", "vendor id", "product id", "filter"],
        copy: ["Vendor ID (hex)", "Product ID (hex)", "Name contains"],
        valuePaths: [
          "serialSettings.portSelection.vid",
          "serialSettings.portSelection.pid",
          "serialSettings.portSelection.match",
        ],
      },
      {
        id: "serial-baud-rate",
      ...
      {
        id: "mysql-dialect",
        label: "MySQL / MariaDB server dialect",
        protocols: ["mysql"],
        protocolSubtabId: "connection",
        keywords: ["mariadb", "mysql", "dialect", "version", "detect"],
        optionText: ["Detect from server (default)", "MySQL", "MariaDB"],
        valuePaths: ["mysqlDialectHint"],
      },
      {
        id: "mysql-tls-mode",
        label: "MySQL / MariaDB TLS mode",
        protocols: ["mysql"],
        protocolSubtabId: "security",
        keywords: ["ssl", "tls", "encryption", "certificate verification"],
        optionText: [
          "Disabled",
          "Preferred (default)",
          "Require encryption",
        ...
        valuePaths: ["mysqlTls.mode"],
      },
      {
        id: "mysql-ca-certificate",
        label: "MySQL / MariaDB CA certificate path",
        protocols: ["mysql"],
        protocolSubtabId: "security",
        keywords: ["ssl root certificate", "trust", "verify ca"],
        valuePaths: ["mysqlTls.caPath"],
      },
      {
        id: "mysql-client-certificate",
        label: "MySQL / MariaDB client certificate path",
        protocols: ["mysql"],
        protocolSubtabId: "security",
        keywords: ["mutual tls", "mtls", "ssl certificate"],
        valuePaths: ["mysqlTls.clientCertPath"],
      },
      {
        id: "mysql-client-key",
        label: "MySQL / MariaDB client key path",
        protocols: ["mysql"],
        protocolSubtabId: "security",
        keywords: ["mutual tls", "mtls", "ssl key"],
        valuePaths: ["mysqlTls.clientKeyPath"],
      },
      {
        id: "mysql-direct-route",
        label: "MySQL / MariaDB direct-only network path",
        protocols: ["mysql"],
        protocolSubtabId: "security",
      ...
      },
      {
        ...
        label: "MongoDB replica set name",
        protocols: ["mongodb"],
        protocolSubtabId: "connection",
        keywords: ["mongo", "replica set", "cluster", "rs0"],
        valuePaths: ["mongoReplicaSet"],
      },
      {
        ...
        protocols: ["mongodb"],
        protocolSubtabId: "connection",
        keywords: ["mongo", "uri", "mongodb+srv", "override host"],
      },
      {
        id: "mongodb-username",
      ...
      },
      {
        ...
        protocols: ["mongodb"],
        protocolSubtabId: "authentication",
        keywords: ["mongo", "credential"],
      },
      {
        id: "mongodb-auth-database",
        label: "MongoDB authentication database",
        protocols: ["mongodb"],
        protocolSubtabId: "authentication",
        keywords: ["mongo", "authsource", "auth source", "admin"],
        valuePaths: ["mongoAuthDatabase"],
      },
      {
        id: "mongodb-tls",
        label: "MongoDB TLS",
        protocols: ["mongodb"],
        protocolSubtabId: "security",
        keywords: ["mongo", "ssl", "encryption", "use tls"],
        valuePaths: ["mongoTls.enabled"],
      },
      {
        id: "mongodb-ca-certificate",
        label: "MongoDB CA certificate path",
        protocols: ["mongodb"],
        protocolSubtabId: "security",
        keywords: ["mongo", "root certificate", "trust"],
        valuePaths: ["mongoTls.caPath"],
      },
      {
        id: "mongodb-client-certificate",
        label: "MongoDB client certificate and key path",
        protocols: ["mongodb"],
        protocolSubtabId: "security",
        keywords: ["mongo", "x509", "mutual tls", "mtls", "pem"],
        valuePaths: ["mongoTls.certKeyPath"],
      },
      {
        id: "mongodb-tls-allow-invalid",
        label: "MongoDB allow invalid certificates",
        protocols: ["mongodb"],
        protocolSubtabId: "security",
        keywords: ["mongo", "skip verification", "self-signed", "insecure"],
        valuePaths: ["mongoTls.allowInvalid"],
      },
      {
        id: "mongodb-direct-route",
        label: "MongoDB direct-only network path",
        protocols: ["mongodb"],
        protocolSubtabId: "security",
        keywords: ["proxy", "vpn", "ssh hop", "tunnel chain", "fail closed"],
        copy: [
      ...
      },
      {
        ...
        label: "MongoDB read preference",
        protocols: ["mongodb"],
        protocolSubtabId: "advanced",
        keywords: ["mongo", "primary", "secondary", "nearest"],
        optionText: [
          "Primary (default)",
          "Primary preferred",
          "Secondary",
        ...
        valuePaths: ["mongoReadPreference"],
      },
      {
        id: "mongodb-direct-connection",
        label: "MongoDB direct connection",
        protocols: ["mongodb"],
        protocolSubtabId: "advanced",
        keywords: ["mongo", "directconnection", "skip discovery"],
        valuePaths: ["mongoDirectConnection"],
      },
      {
