...
const ConditionRow: React.FC<ConditionRowProps> = ({
  ...
  <div className="sor-filter-condition-row" data-testid="smart-filter-condition-row">
    <Select
      ...
      data-testid="smart-filter-field"
    />
    ...
    <Select
      ...
      data-testid="smart-filter-operator"
    />
    ...
    <input
      ...
      data-testid="smart-filter-value"
    />
    ...
    <button
      ...
      data-testid="smart-filter-remove-condition"
    >
      ✕
    </button>
  </div>
  ...
  return (
    <div className="sor-filter-manager-backdrop" onClick={onClose}>
      <div
        ...
        data-testid="smart-filter-manager"
      >
        {/* ---------- Header ---------- */}
        ...
        <div className="sor-filter-body">
          ...
          <section className="sor-filter-builder">
            ...
            {/* Logic toggle */}
            <div className="sor-filter-logic-toggle" data-testid="smart-filter-logic-toggle">
            ...
            <div className="sor-filter-conditions">
              {conditions.map((c, i) => (
                <ConditionRow
                  key={`condition-${c.field}-${c.operator}-${i}`}
                  index={i}
                  condition={c}
            ...
            <button className="sor-filter-btn sor-filter-btn-add" onClick={addCondition} data-testid="smart-filter-add-condition">
            ...
            <div className="sor-filter-actions">
              ...
              <button
                ...
                onClick={handleSave}
                disabled={loading}
                data-testid="smart-filter-save-preset"
              >
                {loading
            ...
            {previewCount !== null && (
              <p className="sor-filter-preview-result" data-testid="smart-filter-preview">
