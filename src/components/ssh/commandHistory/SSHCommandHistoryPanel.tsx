        ...
        <div className="px-3 py-2 border-b border-[var(--color-border)] bg-[var(--color-surfaceHover)]/30 space-y-2">
          <div className="flex items-center gap-2 flex-wrap">
            ...
            <button
              ...
              className="text-xs px-3 py-1 bg-success hover:bg-success/90 text-[var(--color-text)] rounded transition-colors"
            >
        ...
        <div className="p-3 space-y-3 overflow-y-auto">
          ...
          <div className="pt-3 border-t border-[var(--color-border)]">
            <button
              ...
              className="text-xs px-3 py-1.5 bg-error hover:bg-error/90 text-[var(--color-text)] rounded transition-colors"
            >
