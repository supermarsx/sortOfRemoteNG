  ...
  return (
    <div className="space-y-4" data-testid="mcp-resources-tab">
      ...
      <div className="space-y-2">
        <h3 className="text-[10px] font-semibold uppercase tracking-wide text-[var(--color-textSecondary)]">
        ...
        {mgr.resources.map((r) => (
          ...
          >
            ...
            {r.description && (
              <p className="text-[10px] text-[var(--color-textSecondary)]">{r.description}</p>
            )}
          </div>
        ))}
      </div>
