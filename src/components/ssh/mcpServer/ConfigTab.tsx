      ...
      <Section title={t("mcpServer.config.security", "Security")} icon={<Shield size={14} />}>
        ...
        {draft.require_auth && (
          <div className="space-y-2">
            <label className="block text-xs font-medium text-[var(--color-textSecondary)]">
            ...
            <div className="flex items-center gap-2">
              <div className="flex-1 flex items-center gap-1 bg-[var(--color-surface)] rounded-md border border-[var(--color-border)] px-3 py-1.5">
                ...
                <button
                  ...
                  className="text-[var(--color-textSecondary)] hover:text-[var(--color-text-primary)]"
                >
...
const Toggle: React.FC<{
  ...
  <label className="flex items-start gap-3 cursor-pointer">
    ...
    <div>
      ...
      {description && (
        <div className="text-[10px] text-[var(--color-textSecondary)]">{description}</div>
      )}
    </div>
  </label>
);
...
const TextInput: React.FC<{
  ...
  <div>
    <label className="block text-[10px] font-medium text-[var(--color-textSecondary)] mb-1">{label}</label>
    <input
      type="text"
      value={value}
