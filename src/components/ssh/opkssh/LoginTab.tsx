    ...
    <div className="space-y-4">
      ...
      <div className="p-4 rounded-lg border border-[var(--color-border)] bg-[var(--color-surfaceHover)]">
        ...
        <div className="space-y-3">
          ...
          {/* Login button */}
          <button
            className="flex items-center gap-2 text-xs px-4 py-2 rounded bg-success hover:bg-success/90 text-[var(--color-text)] disabled:opacity-50 transition-colors"
            onClick={handleLogin}
      ...
      {mgr.lastLoginResult && (
        ...
        >
          ...
          <div className="space-y-1 text-[var(--color-textSecondary)]">
