...
export const ProvidersTab: React.FC<ProvidersTabProps> = ({ mgr }) => {
  ...
  return (
    <div className="space-y-4">
      ...
      {/* Config file info */}
      {config && (
        <div className="p-3 rounded-lg border border-[var(--color-border)] bg-[var(--color-surfaceHover)] text-xs">
            ...
            {config.providers.map((p) => (
              ...
              >
                <div className="flex-1">
                  ...
                  <div className="text-[var(--color-textSecondary)]">{p.issuer}</div>
                  <div className="text-[var(--color-textSecondary)]">
        ...
        {config && (
          <div className="space-y-2 pt-2 border-t border-[var(--color-border)]">
            <div className="grid grid-cols-2 gap-2 text-xs">
              ...
              />
              <button
                className="flex items-center justify-center gap-1 px-2 py-1 rounded bg-primary hover:bg-primary/90 text-[var(--color-text)] transition-colors disabled:opacity-50"
      ...
      <div className="p-4 rounded-lg border border-[var(--color-border)] bg-[var(--color-surfaceHover)]">
        ...
        <button
          className="flex items-center gap-1 text-xs px-3 py-1 rounded bg-[var(--color-surface)] hover:bg-[var(--color-surfaceHover)] text-[var(--color-text)] border border-[var(--color-border)] transition-colors mb-2"
        ...
        {envString !== null && (
          <div className="flex items-start gap-2">
            <pre className="flex-1 p-2 text-[10px] bg-black/20 rounded border border-[var(--color-border)] text-[var(--color-textSecondary)] font-mono overflow-x-auto">
              OPKSSH_PROVIDERS=&quot;{envString}&quot;
            </pre>
            <button
              className="p-1.5 rounded hover:bg-[var(--color-surfaceHover)] transition-colors"
