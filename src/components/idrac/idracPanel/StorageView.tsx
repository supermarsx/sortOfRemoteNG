            ...
            <tbody>
              {mgr.storageControllers.map((c) => (
                <tr key={c.id} className="border-b border-[var(--color-border)] last:border-0">
                  ...
                  <td className="py-1 text-[var(--color-text-secondary)]">{c.model ?? "—"}</td>
                  <td className="py-1 text-[var(--color-text-secondary)]">{c.firmwareVersion ?? "—"}</td>
            ...
            <tbody>
              {mgr.physicalDisks.map((pd) => (
                <tr key={pd.id} className="border-b border-[var(--color-border)] last:border-0">
                  ...
                  <td className="py-1 text-[var(--color-text-secondary)]">{pd.model ?? "—"}</td>
                  ...
                  <td className="py-1 text-[var(--color-text-secondary)]">{pd.protocol ?? "—"}</td>
                  <td className="py-1 text-right text-[var(--color-text)]">
