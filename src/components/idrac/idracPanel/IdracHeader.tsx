...
const IdracHeader: React.FC<SubPropsWithClose> = ({ mgr, onClose }) => {
  ...
  return (
    <div className="flex items-center gap-3 px-4 py-3 border-b border-[var(--color-border)] bg-[var(--color-surfaceHover)]">
      ...
      <div className="ml-auto flex items-center gap-2">
        ...
        <div className="flex items-center gap-1.5 text-[10px]">
          {isConnected ? (
            ...
            <>
              <WifiOff className="w-3 h-3 text-[var(--color-textSecondary)]" />
        ...
        {isConnected && (
          <button
            ...
            className="p-1.5 rounded-lg hover:bg-[var(--color-bg)] text-[var(--color-textSecondary)] hover:text-[var(--color-text)] transition-colors disabled:opacity-50"
        ...
        {isConnected && (
          <button
            ...
            className="p-1.5 rounded-lg hover:bg-[var(--color-bg)] text-[var(--color-textSecondary)] hover:text-error transition-colors"
        ...
        <button
          onClick={onClose}
          className="p-1.5 rounded-lg hover:bg-[var(--color-bg)] text-[var(--color-textSecondary)] hover:text-[var(--color-text)] transition-colors"
        >
