      ...
      {ts && (
        <div className="rounded-lg border border-[var(--color-border)] bg-[var(--color-bg-secondary)] p-4">
          ...
          <div className="grid grid-cols-4 gap-4">
            <div>
              <p className="text-[10px] text-[var(--color-text-secondary)]">Inlet</p>
              <p className="text-sm font-semibold text-[var(--color-text)]">
                {ts.inletTempCelsius != null ? `${ts.inletTempCelsius} °C` : "N/A"}
              </p>
            </div>
            <div>
              <p className="text-[10px] text-[var(--color-text-secondary)]">Exhaust</p>
              <p className="text-sm font-semibold text-[var(--color-text)]">
            ...
            <tbody>
              {td.temperatures.map((s) => (
                <tr key={s.id} className="border-b border-[var(--color-border)] last:border-0">
                  ...
                  <td className="py-1 text-[var(--color-text-secondary)]">{s.physicalContext ?? "—"}</td>
