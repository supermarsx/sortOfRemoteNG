        ...
        <button
          ...
          className={`flex items-center gap-1.5 px-3 py-1.5 text-sm rounded-t-md transition-colors whitespace-nowrap ${
            mgr.activeTab === key
              ...
              : "text-[var(--color-text-muted)] hover:text-[var(--color-text)] hover:bg-[var(--color-surfaceHover)]"
          }`}
        >
          ...
          <div className="flex gap-2">
            {!s?.running ? (
              <button
                ...
                className="flex items-center gap-1.5 px-3 py-1.5 text-sm bg-success text-[var(--color-text)] rounded-md hover:bg-success/90 transition-colors"
              >
              ...
              <button
                ...
                className="flex items-center gap-1.5 px-3 py-1.5 text-sm bg-error text-[var(--color-text)] rounded-md hover:bg-error/90 transition-colors"
              >
...
const CertificateCard: React.FC<{ cert: ManagedCertificate; mgr: Mgr }> = ({
  ...
  return (
    <div className="p-4 rounded-lg border border-[var(--color-border)] bg-[var(--color-surfaceHover)] hover:border-[var(--color-border-hover)] transition-colors">
      <div className="flex items-start justify-between">
        ...
        <div className="flex gap-1 ml-3 shrink-0">
          <button
            ...
            className="p-1.5 rounded hover:bg-[var(--color-surfaceHover)] text-[var(--color-text-muted)] hover:text-primary transition-colors"
          ...
          <button
            ...
            className="p-1.5 rounded hover:bg-[var(--color-surfaceHover)] text-[var(--color-text-muted)] hover:text-warning transition-colors"
          ...
          <button
            ...
            className="p-1.5 rounded hover:bg-[var(--color-surfaceHover)] text-[var(--color-text-muted)] hover:text-error transition-colors"
...
const AccountCard: React.FC<{ account: AcmeAccount; mgr: Mgr }> = ({
  ...
  const { t } = useTranslation();
  return (
    <div className="p-3 rounded-lg border border-[var(--color-border)] bg-[var(--color-surfaceHover)] flex items-center justify-between">
      <div>
        <div className="flex items-center gap-2 mb-1">
    ...
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
        {items.map((item) => (
          <div
            key={item.label}
            className="p-3 rounded-lg border border-[var(--color-border)] bg-[var(--color-surfaceHover)] text-center"
          >
...
export const LetsEncryptManager: React.FC<LetsEncryptManagerProps> = ({
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} panelClassName="max-w-4xl max-h-[90vh]" dataTestId="lets-encrypt-manager">
      <ModalHeader>
        <div className="flex items-center gap-2">
